...
// checks if the AuthenticatorSMSStageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthenticatorSMSStageRequest{}
...
type _AuthenticatorSMSStageRequest AuthenticatorSMSStageRequest
...
func (o AuthenticatorSMSStageRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AuthenticatorSMSStageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthenticatorSMSStageRequest := _AuthenticatorSMSStageRequest{}

	err = json.Unmarshal(data, &varAuthenticatorSMSStageRequest)

	if err != nil {
		return err
	}

	*o = AuthenticatorSMSStageRequest(varAuthenticatorSMSStageRequest)
