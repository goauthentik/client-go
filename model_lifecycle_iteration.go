...
func NewLifecycleIteration(id string, contentType ContentTypeEnum, objectId string, objectVerbose string, objectAdminUrl string, state LifecycleIterationStateEnum, openedOn time.Time, gracePeriodEnd time.Time, nextReviewDate time.Time, reviews []Review, rule RelatedRule, userCanReview bool) *LifecycleIteration {
...
func (o *LifecycleIteration) GetRule() RelatedRule {
	if o == nil {
		var ret RelatedRule
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LifecycleIteration) GetRuleOk() (*RelatedRule, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Rule, true
...
func (o *LifecycleIteration) SetRule(v RelatedRule) {
	o.Rule = v
}
