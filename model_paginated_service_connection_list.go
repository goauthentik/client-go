...
// checks if the PaginatedServiceConnectionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedServiceConnectionList{}
...
type _PaginatedServiceConnectionList PaginatedServiceConnectionList
...
func (o PaginatedServiceConnectionList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedServiceConnectionList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedServiceConnectionList := _PaginatedServiceConnectionList{}

	err = json.Unmarshal(data, &varPaginatedServiceConnectionList)

	if err != nil {
		return err
	}

	*o = PaginatedServiceConnectionList(varPaginatedServiceConnectionList)
