...
// checks if the PaginatedPermissionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedPermissionList{}
...
type _PaginatedPermissionList PaginatedPermissionList
...
func (o PaginatedPermissionList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedPermissionList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedPermissionList := _PaginatedPermissionList{}

	err = json.Unmarshal(data, &varPaginatedPermissionList)

	if err != nil {
		return err
	}

	*o = PaginatedPermissionList(varPaginatedPermissionList)
