...
// checks if the PaginatedGoogleWorkspaceProviderGroupList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedGoogleWorkspaceProviderGroupList{}
...
func (o PaginatedGoogleWorkspaceProviderGroupList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedGoogleWorkspaceProviderGroupList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedGoogleWorkspaceProviderGroupList := _PaginatedGoogleWorkspaceProviderGroupList{}

	err = json.Unmarshal(data, &varPaginatedGoogleWorkspaceProviderGroupList)

	if err != nil {
		return err
	}

	*o = PaginatedGoogleWorkspaceProviderGroupList(varPaginatedGoogleWorkspaceProviderGroupList)
