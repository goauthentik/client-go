...
// checks if the PropertyMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PropertyMapping{}
...
type _PropertyMapping PropertyMapping
...
func (o PropertyMapping) ToMap() (map[string]interface{}, error) {
...
func (o *PropertyMapping) UnmarshalJSON(data []byte) (err error) {
	...
	varPropertyMapping := _PropertyMapping{}

	err = json.Unmarshal(data, &varPropertyMapping)

	if err != nil {
		return err
	}

	*o = PropertyMapping(varPropertyMapping)
