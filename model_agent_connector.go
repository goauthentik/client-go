...
func NewAgentConnector(name string, component string, verboseName string, verboseNamePlural string, metaModelName string, domainName string) *AgentConnector {
	this := AgentConnector{}
	this.Name = name
...
func (o *AgentConnector) GetDomainName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AgentConnector) GetDomainNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AgentConnector) SetDomainName(v string) {
	o.DomainName = v
}
