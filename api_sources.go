...
func (r ApiSourcesLdapListRequest) SyncGroupHierarchy(syncGroupHierarchy bool) ApiSourcesLdapListRequest {
	r.syncGroupHierarchy = &syncGroupHierarchy
	return r
}
...
func (a *SourcesAPIService) SourcesLdapListExecute(r ApiSourcesLdapListRequest) (*PaginatedLDAPSourceList, *http.Response, error) {
	...
	if r.syncGroupHierarchy != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sync_group_hierarchy", r.syncGroupHierarchy, "form", "")
	}
	if r.syncGroups != nil {
...
func (r ApiSourcesSamlListRequest) IssuerOverride(issuerOverride string) ApiSourcesSamlListRequest {
