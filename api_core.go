...
type ApiCoreApplicationEntitlementsRequestableListRequest struct {
	ctx        context.Context
	ApiService *CoreAPIService
	app        *string
	name       *string
...
func (r ApiCoreApplicationEntitlementsRequestableListRequest) App(app string) ApiCoreApplicationEntitlementsRequestableListRequest {
	r.app = &app
	return r
}

func (r ApiCoreApplicationEntitlementsRequestableListRequest) Name(name string) ApiCoreApplicationEntitlementsRequestableListRequest {
	r.name = &name
	return r
}

// Which field to use when ordering the results.
func (r ApiCoreApplicationEntitlementsRequestableListRequest) Ordering(ordering string) ApiCoreApplicationEntitlementsRequestableListRequest {
	r.ordering = &ordering
	return r
}

// A page number within the paginated result set.
func (r ApiCoreApplicationEntitlementsRequestableListRequest) Page(page int32) ApiCoreApplicationEntitlementsRequestableListRequest {
	r.page = &page
	return r
}

// Number of results to return per page.
func (r ApiCoreApplicationEntitlementsRequestableListRequest) PageSize(pageSize int32) ApiCoreApplicationEntitlementsRequestableListRequest {
	r.pageSize = &pageSize
	return r
}

func (r ApiCoreApplicationEntitlementsRequestableListRequest) PbmUuid(pbmUuid string) ApiCoreApplicationEntitlementsRequestableListRequest {
	r.pbmUuid = &pbmUuid
	return r
}

// A search term.
func (r ApiCoreApplicationEntitlementsRequestableListRequest) Search(search string) ApiCoreApplicationEntitlementsRequestableListRequest {
	r.search = &search
	return r
}

func (r ApiCoreApplicationEntitlementsRequestableListRequest) Execute() (*PaginatedRequestableTargetList, *http.Response, error) {
	return r.ApiService.CoreApplicationEntitlementsRequestableListExecute(r)
}

/*
CoreApplicationEntitlementsRequestableList Method for CoreApplicationEntitlementsRequestableList

List application entitlements which the current user can request access to

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCoreApplicationEntitlementsRequestableListRequest
*/
func (a *CoreAPIService) CoreApplicationEntitlementsRequestableList(ctx context.Context) ApiCoreApplicationEntitlementsRequestableListRequest {
	return ApiCoreApplicationEntitlementsRequestableListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CoreAPIService) CoreApplicationEntitlementsRequestableListExecute(r ApiCoreApplicationEntitlementsRequestableListRequest) (*PaginatedRequestableTargetList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *PaginatedRequestableTargetList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CoreAPIService.CoreApplicationEntitlementsRequestableList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/core/application_entitlements/requestable/"
...
type ApiCoreApplicationsRequestableListRequest struct {
	ctx             context.Context
	ApiService      *CoreAPIService
	group           *string
	metaDescription *string
...
func (r ApiCoreApplicationsRequestableListRequest) Group(group string) ApiCoreApplicationsRequestableListRequest {
	r.group = &group
	return r
}

func (r ApiCoreApplicationsRequestableListRequest) MetaDescription(metaDescription string) ApiCoreApplicationsRequestableListRequest {
	r.metaDescription = &metaDescription
	return r
}

func (r ApiCoreApplicationsRequestableListRequest) MetaLaunchUrl(metaLaunchUrl string) ApiCoreApplicationsRequestableListRequest {
	r.metaLaunchUrl = &metaLaunchUrl
	return r
}

func (r ApiCoreApplicationsRequestableListRequest) MetaPublisher(metaPublisher string) ApiCoreApplicationsRequestableListRequest {
	r.metaPublisher = &metaPublisher
	return r
}

func (r ApiCoreApplicationsRequestableListRequest) Name(name string) ApiCoreApplicationsRequestableListRequest {
	r.name = &name
	return r
}

// Which field to use when ordering the results.
func (r ApiCoreApplicationsRequestableListRequest) Ordering(ordering string) ApiCoreApplicationsRequestableListRequest {
	r.ordering = &ordering
	return r
}

// A page number within the paginated result set.
func (r ApiCoreApplicationsRequestableListRequest) Page(page int32) ApiCoreApplicationsRequestableListRequest {
	r.page = &page
	return r
}

// Number of results to return per page.
func (r ApiCoreApplicationsRequestableListRequest) PageSize(pageSize int32) ApiCoreApplicationsRequestableListRequest {
	r.pageSize = &pageSize
	return r
}

// A search term.
func (r ApiCoreApplicationsRequestableListRequest) Search(search string) ApiCoreApplicationsRequestableListRequest {
	r.search = &search
	return r
}

func (r ApiCoreApplicationsRequestableListRequest) Slug(slug string) ApiCoreApplicationsRequestableListRequest {
	r.slug = &slug
	return r
}

func (r ApiCoreApplicationsRequestableListRequest) Execute() (*PaginatedApplicationList, *http.Response, error) {
	return r.ApiService.CoreApplicationsRequestableListExecute(r)
}

/*
CoreApplicationsRequestableList Method for CoreApplicationsRequestableList

List applications which the current user can request access to

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCoreApplicationsRequestableListRequest
*/
func (a *CoreAPIService) CoreApplicationsRequestableList(ctx context.Context) ApiCoreApplicationsRequestableListRequest {
	return ApiCoreApplicationsRequestableListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return PaginatedApplicationList
func (a *CoreAPIService) CoreApplicationsRequestableListExecute(r ApiCoreApplicationsRequestableListRequest) (*PaginatedApplicationList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CoreAPIService.CoreApplicationsRequestableList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/core/applications/requestable/"
...
func (r ApiCoreUsersAccountLockdownCreateRequest) Execute() (*Link, *http.Response, error) {
...
//
//	@return Link
func (a *CoreAPIService) CoreUsersAccountLockdownCreateExecute(r ApiCoreUsersAccountLockdownCreateRequest) (*Link, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiCoreUsersSwitchCreateRequest struct {
	ctx               context.Context
	ApiService        *CoreAPIService
	next              *string
...
func (r ApiCoreUsersSwitchCreateRequest) Next(next string) ApiCoreUsersSwitchCreateRequest {
	r.next = &next
	return r
}

func (r ApiCoreUsersSwitchCreateRequest) UserSwitchRequest(userSwitchRequest UserSwitchRequest) ApiCoreUsersSwitchCreateRequest {
	r.userSwitchRequest = &userSwitchRequest
	return r
}

func (r ApiCoreUsersSwitchCreateRequest) Execute() (*UserSwitchResponse, *http.Response, error) {
	return r.ApiService.CoreUsersSwitchCreateExecute(r)
}

/*
CoreUsersSwitchCreate Method for CoreUsersSwitchCreate

Start browser user switching.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCoreUsersSwitchCreateRequest
*/
func (a *CoreAPIService) CoreUsersSwitchCreate(ctx context.Context) ApiCoreUsersSwitchCreateRequest {
	return ApiCoreUsersSwitchCreateRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CoreAPIService) CoreUsersSwitchCreateExecute(r ApiCoreUsersSwitchCreateRequest) (*UserSwitchResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UserSwitchResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CoreAPIService.CoreUsersSwitchCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/core/users/switch/"
	...
	// body params
	localVarPostBody = r.userSwitchRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
