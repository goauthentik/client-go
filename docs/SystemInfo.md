...
**BaseUrl** | **string** | Configured external base URL. Can be empty | [readonly] 

## Methods

### NewSystemInfo

`func NewSystemInfo(httpHeaders map[string]string, httpHost string, httpIsSecure bool, runtime SystemInfoRuntime, brand string, serverTime time.Time, embeddedOutpostDisabled bool, embeddedOutpostHost string, baseUrl string, ) *SystemInfo`
...
`func (o *SystemInfo) GetBaseUrl() string`

GetBaseUrl returns the BaseUrl field if non-nil, zero value otherwise.

### GetBaseUrlOk

`func (o *SystemInfo) GetBaseUrlOk() (*string, bool)`
...
`func (o *SystemInfo) SetBaseUrl(v string)`
