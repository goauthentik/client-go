...
`func (o *SettingsRequest) GetBaseUrl() string`

GetBaseUrl returns the BaseUrl field if non-nil, zero value otherwise.

### GetBaseUrlOk

`func (o *SettingsRequest) GetBaseUrlOk() (*string, bool)`
...
`func (o *SettingsRequest) SetBaseUrl(v string)`

SetBaseUrl sets BaseUrl field to given value.

### HasBaseUrl

`func (o *SettingsRequest) HasBaseUrl() bool`
