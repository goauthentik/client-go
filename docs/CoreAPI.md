...
[**CoreApplicationEntitlementsRequestableList**](CoreAPI.md#CoreApplicationEntitlementsRequestableList) | **Get** /core/application_entitlements/requestable/ | 
...
[**CoreApplicationsRequestableList**](CoreAPI.md#CoreApplicationsRequestableList) | **Get** /core/applications/requestable/ | 
...
[**CoreObjectAttributesCreate**](CoreAPI.md#CoreObjectAttributesCreate) | **Post** /core/object_attributes/ | 
[**CoreObjectAttributesDestroy**](CoreAPI.md#CoreObjectAttributesDestroy) | **Delete** /core/object_attributes/{attribute_id}/ | 
[**CoreObjectAttributesList**](CoreAPI.md#CoreObjectAttributesList) | **Get** /core/object_attributes/ | 
[**CoreObjectAttributesPartialUpdate**](CoreAPI.md#CoreObjectAttributesPartialUpdate) | **Patch** /core/object_attributes/{attribute_id}/ | 
[**CoreObjectAttributesRetrieve**](CoreAPI.md#CoreObjectAttributesRetrieve) | **Get** /core/object_attributes/{attribute_id}/ | 
[**CoreObjectAttributesUpdate**](CoreAPI.md#CoreObjectAttributesUpdate) | **Put** /core/object_attributes/{attribute_id}/ | 
...
[**CoreUsersSwitchCreate**](CoreAPI.md#CoreUsersSwitchCreate) | **Post** /core/users/switch/ | 
...
## CoreApplicationEntitlementsRequestableList

> PaginatedRequestableTargetList CoreApplicationEntitlementsRequestableList(ctx).App(app).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).PbmUuid(pbmUuid).Search(search).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CoreAPI.CoreApplicationEntitlementsRequestableList(context.Background()).App(app).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).PbmUuid(pbmUuid).Search(search).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CoreAPI.CoreApplicationEntitlementsRequestableList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CoreApplicationEntitlementsRequestableList`: PaginatedRequestableTargetList
	fmt.Fprintf(os.Stdout, "Response from `CoreAPI.CoreApplicationEntitlementsRequestableList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCoreApplicationEntitlementsRequestableListRequest struct via the builder pattern
...
> PaginatedApplicationList CoreApplicationsRequestableList(ctx).Group(group).MetaDescription(metaDescription).MetaLaunchUrl(metaLaunchUrl).MetaPublisher(metaPublisher).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Slug(slug).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CoreAPI.CoreApplicationsRequestableList(context.Background()).Group(group).MetaDescription(metaDescription).MetaLaunchUrl(metaLaunchUrl).MetaPublisher(metaPublisher).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Slug(slug).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CoreAPI.CoreApplicationsRequestableList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CoreApplicationsRequestableList`: PaginatedApplicationList
	fmt.Fprintf(os.Stdout, "Response from `CoreAPI.CoreApplicationsRequestableList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCoreApplicationsRequestableListRequest struct via the builder pattern
...
func main() {
	...
	flowLockdown := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
	flowRecovery := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
	flowRequest := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
	...
	flowUserSwitch := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
	search := "search_example" // string | A search term. (optional)
...
## CoreObjectAttributesCreate

> ObjectAttribute CoreObjectAttributesCreate(ctx).ObjectAttributeRequest(objectAttributeRequest).Execute()
...
func main() {
	objectAttributeRequest := *openapiclient.NewObjectAttributeRequest("ObjectType_example", "Key_example", "Label_example", openapiclient.ObjectAttributeTypeEnum("text")) // ObjectAttributeRequest | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CoreAPI.CoreObjectAttributesCreate(context.Background()).ObjectAttributeRequest(objectAttributeRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CoreAPI.CoreObjectAttributesCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CoreObjectAttributesCreate`: ObjectAttribute
	fmt.Fprintf(os.Stdout, "Response from `CoreAPI.CoreObjectAttributesCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCoreObjectAttributesCreateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **objectAttributeRequest** | [**ObjectAttributeRequest**](ObjectAttributeRequest.md) |  | 
...
## CoreObjectAttributesDestroy

> CoreObjectAttributesDestroy(ctx, attributeId).Execute()
...
func main() {
	attributeId := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this Object Attribute.

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.CoreAPI.CoreObjectAttributesDestroy(context.Background(), attributeId).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CoreAPI.CoreObjectAttributesDestroy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**attributeId** | **string** | A UUID string identifying this Object Attribute. | 

### Other Parameters

Other parameters are passed through a pointer to a apiCoreObjectAttributesDestroyRequest struct via the builder pattern
...
> PaginatedObjectAttributeList CoreObjectAttributesList(ctx).Enabled(enabled).ObjectTypeAppLabel(objectTypeAppLabel).ObjectTypeModel(objectTypeModel).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Execute()
...
func main() {
	...
	objectTypeAppLabel := "objectTypeAppLabel_example" // string |  (optional)
	objectTypeModel := "objectTypeModel_example" // string |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
	search := "search_example" // string | A search term. (optional)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CoreAPI.CoreObjectAttributesList(context.Background()).Enabled(enabled).ObjectTypeAppLabel(objectTypeAppLabel).ObjectTypeModel(objectTypeModel).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CoreAPI.CoreObjectAttributesList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CoreObjectAttributesList`: PaginatedObjectAttributeList
	fmt.Fprintf(os.Stdout, "Response from `CoreAPI.CoreObjectAttributesList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCoreObjectAttributesListRequest struct via the builder pattern
...
## CoreObjectAttributesPartialUpdate

> ObjectAttribute CoreObjectAttributesPartialUpdate(ctx, attributeId).PatchedObjectAttributeRequest(patchedObjectAttributeRequest).Execute()
...
func main() {
	attributeId := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this Object Attribute.
	patchedObjectAttributeRequest := *openapiclient.NewPatchedObjectAttributeRequest() // PatchedObjectAttributeRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CoreAPI.CoreObjectAttributesPartialUpdate(context.Background(), attributeId).PatchedObjectAttributeRequest(patchedObjectAttributeRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CoreAPI.CoreObjectAttributesPartialUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CoreObjectAttributesPartialUpdate`: ObjectAttribute
	fmt.Fprintf(os.Stdout, "Response from `CoreAPI.CoreObjectAttributesPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCoreObjectAttributesPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedObjectAttributeRequest** | [**PatchedObjectAttributeRequest**](PatchedObjectAttributeRequest.md) |  | 
...
## CoreObjectAttributesRetrieve

> ObjectAttribute CoreObjectAttributesRetrieve(ctx, attributeId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CoreAPI.CoreObjectAttributesRetrieve(context.Background(), attributeId).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CoreAPI.CoreObjectAttributesRetrieve``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CoreObjectAttributesRetrieve`: ObjectAttribute
	fmt.Fprintf(os.Stdout, "Response from `CoreAPI.CoreObjectAttributesRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCoreObjectAttributesRetrieveRequest struct via the builder pattern
...
## CoreObjectAttributesUpdate

> ObjectAttribute CoreObjectAttributesUpdate(ctx, attributeId).ObjectAttributeRequest(objectAttributeRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CoreAPI.CoreObjectAttributesUpdate(context.Background(), attributeId).ObjectAttributeRequest(objectAttributeRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CoreAPI.CoreObjectAttributesUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CoreObjectAttributesUpdate`: ObjectAttribute
	fmt.Fprintf(os.Stdout, "Response from `CoreAPI.CoreObjectAttributesUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCoreObjectAttributesUpdateRequest struct via the builder pattern
...
func main() {
	...
	intent := openapiclient.IntentEnum("verification") // IntentEnum |  (optional)
...
> Link CoreUsersAccountLockdownCreate(ctx).UserAccountLockdownRequest(userAccountLockdownRequest).Execute()
...
func main() {
	userAccountLockdownRequest := *openapiclient.NewUserAccountLockdownRequest() // UserAccountLockdownRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CoreAPI.CoreUsersAccountLockdownCreate(context.Background()).UserAccountLockdownRequest(userAccountLockdownRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CoreAPI.CoreUsersAccountLockdownCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CoreUsersAccountLockdownCreate`: Link
	fmt.Fprintf(os.Stdout, "Response from `CoreAPI.CoreUsersAccountLockdownCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCoreUsersAccountLockdownCreateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **userAccountLockdownRequest** | [**UserAccountLockdownRequest**](UserAccountLockdownRequest.md) |  | 
...
func main() {
	...
	search := "search_example" // string | A search term. (optional)
	type_ := []openapiclient.UserTypeEnum{openapiclient.UserTypeEnum("internal")} // []UserTypeEnum |  (optional)
 ...
 **rolesByPk** | **[]string** |  | 
 **search** | **string** | A search term. | 
 **type_** | [**[]UserTypeEnum**](UserTypeEnum.md) |  | 
 **username** | **string** |  | 
 **uuid** | **string** |  | 
...
> CoreUsersSetPasswordHashCreate(ctx, id).UserPasswordHashSetRequest(userPasswordHashSetRequest).Execute()
...
func main() {
	id := int32(56) // int32 | A unique integer value identifying this User.
	userPasswordHashSetRequest := *openapiclient.NewUserPasswordHashSetRequest("Password_example") // UserPasswordHashSetRequest | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.CoreAPI.CoreUsersSetPasswordHashCreate(context.Background(), id).UserPasswordHashSetRequest(userPasswordHashSetRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CoreAPI.CoreUsersSetPasswordHashCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiCoreUsersSetPasswordHashCreateRequest struct via the builder pattern
...
## CoreUsersSwitchCreate

> UserSwitchResponse CoreUsersSwitchCreate(ctx).Next(next).UserSwitchRequest(userSwitchRequest).Execute()
...
func main() {
	...
	userSwitchRequest := *openapiclient.NewUserSwitchRequest() // UserSwitchRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CoreAPI.CoreUsersSwitchCreate(context.Background()).Next(next).UserSwitchRequest(userSwitchRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CoreAPI.CoreUsersSwitchCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CoreUsersSwitchCreate`: UserSwitchResponse
	fmt.Fprintf(os.Stdout, "Response from `CoreAPI.CoreUsersSwitchCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCoreUsersSwitchCreateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **next** | **string** |  | 
 **userSwitchRequest** | [**UserSwitchRequest**](UserSwitchRequest.md) |  | 
