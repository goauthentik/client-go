...
`func NewLoginChallengeTypes(type_ ChallengeChoices, component string, to string, clientId string, slug string, scope string, redirectUri string, state string, ) *LoginChallengeTypes`
