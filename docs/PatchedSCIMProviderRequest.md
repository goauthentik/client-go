...
`func (o *PatchedSCIMProviderRequest) GetDiscoveryEnabled() bool`

GetDiscoveryEnabled returns the DiscoveryEnabled field if non-nil, zero value otherwise.

### GetDiscoveryEnabledOk

`func (o *PatchedSCIMProviderRequest) GetDiscoveryEnabledOk() (*bool, bool)`
...
`func (o *PatchedSCIMProviderRequest) SetDiscoveryEnabled(v bool)`

SetDiscoveryEnabled sets DiscoveryEnabled field to given value.

### HasDiscoveryEnabled

`func (o *PatchedSCIMProviderRequest) HasDiscoveryEnabled() bool`
