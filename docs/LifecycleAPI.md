...
> []LifecycleIteration LifecycleIterationsListLatest(ctx, contentType, objectId).Ordering(ordering).Search(search).UserIsReviewer(userIsReviewer).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.LifecycleAPI.LifecycleIterationsListLatest(context.Background(), contentType, objectId).Ordering(ordering).Search(search).UserIsReviewer(userIsReviewer).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `LifecycleAPI.LifecycleIterationsListLatest``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `LifecycleIterationsListLatest`: []LifecycleIteration
	fmt.Fprintf(os.Stdout, "Response from `LifecycleAPI.LifecycleIterationsListLatest`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiLifecycleIterationsListLatestRequest struct via the builder pattern
...
> UserOffboarding LifecycleUserOffboardingCreate(ctx).UserOffboardingRequest(userOffboardingRequest).Execute()
...
func main() {
	userOffboardingRequest := *openapiclient.NewUserOffboardingRequest(int32(123), time.Now()) // UserOffboardingRequest | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.LifecycleAPI.LifecycleUserOffboardingCreate(context.Background()).UserOffboardingRequest(userOffboardingRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `LifecycleAPI.LifecycleUserOffboardingCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `LifecycleUserOffboardingCreate`: UserOffboarding
	fmt.Fprintf(os.Stdout, "Response from `LifecycleAPI.LifecycleUserOffboardingCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiLifecycleUserOffboardingCreateRequest struct via the builder pattern
...
> LifecycleUserOffboardingDestroy(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.LifecycleAPI.LifecycleUserOffboardingDestroy(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `LifecycleAPI.LifecycleUserOffboardingDestroy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiLifecycleUserOffboardingDestroyRequest struct via the builder pattern
...
> PaginatedUserOffboardingList LifecycleUserOffboardingList(ctx).Action(action).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Status(status).UserUuid(userUuid).Execute()
...
func main() {
	action := openapiclient.OffboardingActionEnum("deactivate") // OffboardingActionEnum |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
	search := "search_example" // string | A search term. (optional)
	status := openapiclient.OffboardingStatusEnum("pending") // OffboardingStatusEnum |  (optional)
	userUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.LifecycleAPI.LifecycleUserOffboardingList(context.Background()).Action(action).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Status(status).UserUuid(userUuid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `LifecycleAPI.LifecycleUserOffboardingList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `LifecycleUserOffboardingList`: PaginatedUserOffboardingList
	fmt.Fprintf(os.Stdout, "Response from `LifecycleAPI.LifecycleUserOffboardingList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiLifecycleUserOffboardingListRequest struct via the builder pattern
...
> UserOffboarding LifecycleUserOffboardingRetrieve(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.LifecycleAPI.LifecycleUserOffboardingRetrieve(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `LifecycleAPI.LifecycleUserOffboardingRetrieve``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `LifecycleUserOffboardingRetrieve`: UserOffboarding
	fmt.Fprintf(os.Stdout, "Response from `LifecycleAPI.LifecycleUserOffboardingRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiLifecycleUserOffboardingRetrieveRequest struct via the builder pattern
