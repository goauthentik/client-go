...
func main() {
	actorName := "actorName_example" // string |  (optional)
	aggregatedStatus := []openapiclient.TaskAggregatedStatusEnum{openapiclient.TaskAggregatedStatusEnum("queued")} // []TaskAggregatedStatusEnum |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
	...
	relObjIdIsnull := true // bool |  (optional)
	search := "search_example" // string | A search term. (optional)
	state := openapiclient.TaskStatusEnum("queued") // TaskStatusEnum |  (optional)
