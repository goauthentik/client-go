...
**RequestContentType** | Pointer to [**RequestContentTypeEnum**](RequestContentTypeEnum.md) |  | [optional] 
...
`func (o *PatchedCaptchaStageRequest) GetRequestContentType() RequestContentTypeEnum`

GetRequestContentType returns the RequestContentType field if non-nil, zero value otherwise.

### GetRequestContentTypeOk

`func (o *PatchedCaptchaStageRequest) GetRequestContentTypeOk() (*RequestContentTypeEnum, bool)`
...
`func (o *PatchedCaptchaStageRequest) SetRequestContentType(v RequestContentTypeEnum)`

SetRequestContentType sets RequestContentType field to given value.

### HasRequestContentType

`func (o *PatchedCaptchaStageRequest) HasRequestContentType() bool`
