...
**BaseUrl** | Pointer to **string** | Configure the base URL under which this authentik instance is reachable, e.g. https://authentik.company | [optional] 
...
`func (o *PatchedSettingsRequest) GetBaseUrl() string`

GetBaseUrl returns the BaseUrl field if non-nil, zero value otherwise.

### GetBaseUrlOk

`func (o *PatchedSettingsRequest) GetBaseUrlOk() (*string, bool)`
...
`func (o *PatchedSettingsRequest) SetBaseUrl(v string)`

SetBaseUrl sets BaseUrl field to given value.

### HasBaseUrl

`func (o *PatchedSettingsRequest) HasBaseUrl() bool`
