...
**SyncGroupHierarchy** | Pointer to **bool** | Sync group parentage/hierarchy from LDAP directories. | [optional] 
...
### GetSyncGroupHierarchy

`func (o *PatchedLDAPSourceRequest) GetSyncGroupHierarchy() bool`

GetSyncGroupHierarchy returns the SyncGroupHierarchy field if non-nil, zero value otherwise.

### GetSyncGroupHierarchyOk

`func (o *PatchedLDAPSourceRequest) GetSyncGroupHierarchyOk() (*bool, bool)`

GetSyncGroupHierarchyOk returns a tuple with the SyncGroupHierarchy field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetSyncGroupHierarchy

`func (o *PatchedLDAPSourceRequest) SetSyncGroupHierarchy(v bool)`

SetSyncGroupHierarchy sets SyncGroupHierarchy field to given value.

### HasSyncGroupHierarchy

`func (o *PatchedLDAPSourceRequest) HasSyncGroupHierarchy() bool`

HasSyncGroupHierarchy returns a boolean if a field has been set.
