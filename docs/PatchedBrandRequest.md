...
`func (o *PatchedBrandRequest) GetBrandingMapTiles() string`

GetBrandingMapTiles returns the BrandingMapTiles field if non-nil, zero value otherwise.

### GetBrandingMapTilesOk

`func (o *PatchedBrandRequest) GetBrandingMapTilesOk() (*string, bool)`
...
`func (o *PatchedBrandRequest) SetBrandingMapTiles(v string)`

SetBrandingMapTiles sets BrandingMapTiles field to given value.

### HasBrandingMapTiles

`func (o *PatchedBrandRequest) HasBrandingMapTiles() bool`
...
`func (o *PatchedBrandRequest) GetFlowUserSwitch() string`

GetFlowUserSwitch returns the FlowUserSwitch field if non-nil, zero value otherwise.

### GetFlowUserSwitchOk

`func (o *PatchedBrandRequest) GetFlowUserSwitchOk() (*string, bool)`
...
`func (o *PatchedBrandRequest) GetFlowLockdown() string`

GetFlowLockdown returns the FlowLockdown field if non-nil, zero value otherwise.

### GetFlowLockdownOk

`func (o *PatchedBrandRequest) GetFlowLockdownOk() (*string, bool)`
...
`func (o *PatchedBrandRequest) SetFlowRequest(v string)`

SetFlowRequest sets FlowRequest field to given value.

### HasFlowRequest

`func (o *PatchedBrandRequest) HasFlowRequest() bool`

HasFlowRequest returns a boolean if a field has been set.

### SetFlowRequestNil

`func (o *PatchedBrandRequest) SetFlowRequestNil(b bool)`

 SetFlowRequestNil sets the value for FlowRequest to be an explicit nil

### UnsetFlowRequest
`func (o *PatchedBrandRequest) UnsetFlowRequest()`
