...
`func (o *SAMLSourceRequest) GetIssuerOverride() string`

GetIssuerOverride returns the IssuerOverride field if non-nil, zero value otherwise.

### GetIssuerOverrideOk

`func (o *SAMLSourceRequest) GetIssuerOverrideOk() (*string, bool)`
...
`func (o *SAMLSourceRequest) SetIssuerOverride(v string)`

SetIssuerOverride sets IssuerOverride field to given value.

### HasIssuerOverride

`func (o *SAMLSourceRequest) HasIssuerOverride() bool`
