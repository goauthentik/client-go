...
**GrantTypes** | Pointer to [**[]GrantTypeEnum**](GrantTypeEnum.md) |  | [optional] 
...
**IssuerOverride** | Pointer to **string** | Also known as EntityID. Providing a value overrides the default issuer generated by authentik. | [optional] 
...
**PushVerifyCertificates** | Pointer to **bool** |  | [optional] 
**ReplyUrl** | **string** |  | 
**Wtrealm** | **string** |  | 
**SamlVersion** | Pointer to [**SamlVersionEnum**](SamlVersionEnum.md) | SAML assertion version to issue in the security token. Microsoft Entra ID and classic ADFS-style relying parties typically require SAML 1.1. | [optional] 
...
`func (o *ModelRequest) GetGrantTypes() []GrantTypeEnum`

GetGrantTypes returns the GrantTypes field if non-nil, zero value otherwise.

### GetGrantTypesOk

`func (o *ModelRequest) GetGrantTypesOk() (*[]GrantTypeEnum, bool)`
...
`func (o *ModelRequest) SetGrantTypes(v []GrantTypeEnum)`

SetGrantTypes sets GrantTypes field to given value.

### HasGrantTypes

`func (o *ModelRequest) HasGrantTypes() bool`
...
`func (o *ModelRequest) GetIssuerOverride() string`

GetIssuerOverride returns the IssuerOverride field if non-nil, zero value otherwise.

### GetIssuerOverrideOk

`func (o *ModelRequest) GetIssuerOverrideOk() (*string, bool)`

GetIssuerOverrideOk returns a tuple with the IssuerOverride field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetIssuerOverride

`func (o *ModelRequest) SetIssuerOverride(v string)`

SetIssuerOverride sets IssuerOverride field to given value.

### HasIssuerOverride

`func (o *ModelRequest) HasIssuerOverride() bool`

HasIssuerOverride returns a boolean if a field has been set.
...
### GetPushVerifyCertificates

`func (o *ModelRequest) GetPushVerifyCertificates() bool`

GetPushVerifyCertificates returns the PushVerifyCertificates field if non-nil, zero value otherwise.

### GetPushVerifyCertificatesOk

`func (o *ModelRequest) GetPushVerifyCertificatesOk() (*bool, bool)`

GetPushVerifyCertificatesOk returns a tuple with the PushVerifyCertificates field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetPushVerifyCertificates

`func (o *ModelRequest) SetPushVerifyCertificates(v bool)`

SetPushVerifyCertificates sets PushVerifyCertificates field to given value.

### HasPushVerifyCertificates

`func (o *ModelRequest) HasPushVerifyCertificates() bool`
...
`func (o *ModelRequest) GetSamlVersion() SamlVersionEnum`

GetSamlVersion returns the SamlVersion field if non-nil, zero value otherwise.

### GetSamlVersionOk

`func (o *ModelRequest) GetSamlVersionOk() (*SamlVersionEnum, bool)`

GetSamlVersionOk returns a tuple with the SamlVersion field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetSamlVersion

`func (o *ModelRequest) SetSamlVersion(v SamlVersionEnum)`

SetSamlVersion sets SamlVersion field to given value.

### HasSamlVersion

`func (o *ModelRequest) HasSamlVersion() bool`
