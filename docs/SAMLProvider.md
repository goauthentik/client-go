...
**UrlUnified** | **string** | Get unified SAML endpoint URL (handles SSO and SLO) | [readonly] 
**UrlUnifiedInit** | **string** | Get IdP-initiated SAML URL | [readonly] 
...
GetUrlUnified returns the UrlUnified field if non-nil, zero value otherwise.

### GetUrlUnifiedOk

`func (o *SAMLProvider) GetUrlUnifiedOk() (*string, bool)`

GetUrlUnifiedOk returns a tuple with the UrlUnified field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetUrlUnified sets UrlUnified field to given value.
...
GetUrlUnifiedInit returns the UrlUnifiedInit field if non-nil, zero value otherwise.

### GetUrlUnifiedInitOk

`func (o *SAMLProvider) GetUrlUnifiedInitOk() (*string, bool)`

GetUrlUnifiedInitOk returns a tuple with the UrlUnifiedInit field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetUrlUnifiedInit sets UrlUnifiedInit field to given value.
