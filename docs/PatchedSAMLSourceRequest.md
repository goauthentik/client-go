...
**IssuerOverride** | Pointer to **string** | Also known as Entity ID. Defaults to the Metadata URL. | [optional] 
...
**ForceAuthn** | Pointer to **bool** | When enabled, the IdP will re-authenticate the user even if a session exists. | [optional] 
...
`func (o *PatchedSAMLSourceRequest) GetIssuerOverride() string`

GetIssuerOverride returns the IssuerOverride field if non-nil, zero value otherwise.

### GetIssuerOverrideOk

`func (o *PatchedSAMLSourceRequest) GetIssuerOverrideOk() (*string, bool)`
...
`func (o *PatchedSAMLSourceRequest) SetIssuerOverride(v string)`

SetIssuerOverride sets IssuerOverride field to given value.

### HasIssuerOverride

`func (o *PatchedSAMLSourceRequest) HasIssuerOverride() bool`
