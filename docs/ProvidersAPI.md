...
[**ProvidersOauth2DcrCreate**](ProvidersAPI.md#ProvidersOauth2DcrCreate) | **Post** /providers/oauth2-dcr/ | 
[**ProvidersOauth2DcrDestroy**](ProvidersAPI.md#ProvidersOauth2DcrDestroy) | **Delete** /providers/oauth2-dcr/{pbm_uuid}/ | 
[**ProvidersOauth2DcrList**](ProvidersAPI.md#ProvidersOauth2DcrList) | **Get** /providers/oauth2-dcr/ | 
[**ProvidersOauth2DcrPartialUpdate**](ProvidersAPI.md#ProvidersOauth2DcrPartialUpdate) | **Patch** /providers/oauth2-dcr/{pbm_uuid}/ | 
[**ProvidersOauth2DcrRetrieve**](ProvidersAPI.md#ProvidersOauth2DcrRetrieve) | **Get** /providers/oauth2-dcr/{pbm_uuid}/ | 
[**ProvidersOauth2DcrUpdate**](ProvidersAPI.md#ProvidersOauth2DcrUpdate) | **Put** /providers/oauth2-dcr/{pbm_uuid}/ | 
...
## ProvidersOauth2DcrCreate

> OAuth2DynamicClientRegistration ProvidersOauth2DcrCreate(ctx).OAuth2DynamicClientRegistrationRequest(oAuth2DynamicClientRegistrationRequest).Execute()
...
func main() {
	oAuth2DynamicClientRegistrationRequest := *openapiclient.NewOAuth2DynamicClientRegistrationRequest(int32(123)) // OAuth2DynamicClientRegistrationRequest | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ProvidersAPI.ProvidersOauth2DcrCreate(context.Background()).OAuth2DynamicClientRegistrationRequest(oAuth2DynamicClientRegistrationRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProvidersAPI.ProvidersOauth2DcrCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ProvidersOauth2DcrCreate`: OAuth2DynamicClientRegistration
	fmt.Fprintf(os.Stdout, "Response from `ProvidersAPI.ProvidersOauth2DcrCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiProvidersOauth2DcrCreateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **oAuth2DynamicClientRegistrationRequest** | [**OAuth2DynamicClientRegistrationRequest**](OAuth2DynamicClientRegistrationRequest.md) |  | 
...
> ProvidersOauth2DcrDestroy(ctx, pbmUuid).Execute()
...
func main() {
	pbmUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this OAuth2 Dynamic Client Registration.

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.ProvidersAPI.ProvidersOauth2DcrDestroy(context.Background(), pbmUuid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProvidersAPI.ProvidersOauth2DcrDestroy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**pbmUuid** | **string** | A UUID string identifying this OAuth2 Dynamic Client Registration. | 

### Other Parameters

Other parameters are passed through a pointer to a apiProvidersOauth2DcrDestroyRequest struct via the builder pattern
...
> PaginatedOAuth2DynamicClientRegistrationList ProvidersOauth2DcrList(ctx).Ordering(ordering).Page(page).PageSize(pageSize).Provider(provider).Search(search).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ProvidersAPI.ProvidersOauth2DcrList(context.Background()).Ordering(ordering).Page(page).PageSize(pageSize).Provider(provider).Search(search).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProvidersAPI.ProvidersOauth2DcrList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ProvidersOauth2DcrList`: PaginatedOAuth2DynamicClientRegistrationList
	fmt.Fprintf(os.Stdout, "Response from `ProvidersAPI.ProvidersOauth2DcrList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiProvidersOauth2DcrListRequest struct via the builder pattern
...
## ProvidersOauth2DcrPartialUpdate

> OAuth2DynamicClientRegistration ProvidersOauth2DcrPartialUpdate(ctx, pbmUuid).PatchedOAuth2DynamicClientRegistrationRequest(patchedOAuth2DynamicClientRegistrationRequest).Execute()
...
func main() {
	pbmUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this OAuth2 Dynamic Client Registration.
	patchedOAuth2DynamicClientRegistrationRequest := *openapiclient.NewPatchedOAuth2DynamicClientRegistrationRequest() // PatchedOAuth2DynamicClientRegistrationRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ProvidersAPI.ProvidersOauth2DcrPartialUpdate(context.Background(), pbmUuid).PatchedOAuth2DynamicClientRegistrationRequest(patchedOAuth2DynamicClientRegistrationRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProvidersAPI.ProvidersOauth2DcrPartialUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ProvidersOauth2DcrPartialUpdate`: OAuth2DynamicClientRegistration
	fmt.Fprintf(os.Stdout, "Response from `ProvidersAPI.ProvidersOauth2DcrPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiProvidersOauth2DcrPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedOAuth2DynamicClientRegistrationRequest** | [**PatchedOAuth2DynamicClientRegistrationRequest**](PatchedOAuth2DynamicClientRegistrationRequest.md) |  | 
...
## ProvidersOauth2DcrRetrieve

> OAuth2DynamicClientRegistration ProvidersOauth2DcrRetrieve(ctx, pbmUuid).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ProvidersAPI.ProvidersOauth2DcrRetrieve(context.Background(), pbmUuid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProvidersAPI.ProvidersOauth2DcrRetrieve``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ProvidersOauth2DcrRetrieve`: OAuth2DynamicClientRegistration
	fmt.Fprintf(os.Stdout, "Response from `ProvidersAPI.ProvidersOauth2DcrRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiProvidersOauth2DcrRetrieveRequest struct via the builder pattern
...
## ProvidersOauth2DcrUpdate

> OAuth2DynamicClientRegistration ProvidersOauth2DcrUpdate(ctx, pbmUuid).OAuth2DynamicClientRegistrationRequest(oAuth2DynamicClientRegistrationRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ProvidersAPI.ProvidersOauth2DcrUpdate(context.Background(), pbmUuid).OAuth2DynamicClientRegistrationRequest(oAuth2DynamicClientRegistrationRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProvidersAPI.ProvidersOauth2DcrUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ProvidersOauth2DcrUpdate`: OAuth2DynamicClientRegistration
	fmt.Fprintf(os.Stdout, "Response from `ProvidersAPI.ProvidersOauth2DcrUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiProvidersOauth2DcrUpdateRequest struct via the builder pattern
...
func main() {
	...
	clientType := openapiclient.ClientTypeEnum("confidential") // ClientTypeEnum |  (optional)
	includeClaimsInIdToken := true // bool |  (optional)
	issuerMode := openapiclient.IssuerModeEnum("global") // IssuerModeEnum |  (optional)
	name := "name_example" // string |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
	...
	subMode := openapiclient.SubModeEnum("hashed_user_id") // SubModeEnum |  (optional)
...
func main() {
	...
	defaultNameIdPolicy := openapiclient.SAMLNameIDPolicyEnum("urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress") // SAMLNameIDPolicyEnum |  (optional)
	defaultRelayState := "defaultRelayState_example" // string |  (optional)
	digestAlgorithm := openapiclient.DigestAlgorithmEnum("http://www.w3.org/2000/09/xmldsig#sha1") // DigestAlgorithmEnum |  (optional)
	...
	issuerOverride := "issuerOverride_example" // string |  (optional)
	logoutMethod := openapiclient.SAMLLogoutMethods("frontchannel_iframe") // SAMLLogoutMethods |  (optional)
	name := "name_example" // string |  (optional)
	...
	signatureAlgorithm := openapiclient.SignatureAlgorithmEnum("http://www.w3.org/2000/09/xmldsig#rsa-sha1") // SignatureAlgorithmEnum |  (optional)
	signingKp := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
	slsBinding := openapiclient.SAMLBindingsEnum("redirect") // SAMLBindingsEnum |  (optional)
	slsUrl := "slsUrl_example" // string |  (optional)
	spBinding := openapiclient.SAMLBindingsEnum("redirect") // SAMLBindingsEnum |  (optional)
...
func main() {
	...
	forceBinding := openapiclient.ForceBindingEnum("urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST") // ForceBindingEnum |  (optional)
 ...
 **download** | **bool** |  | 
 **forceBinding** | [**ForceBindingEnum**](ForceBindingEnum.md) |  | 
...
> PaginatedWSFederationProviderList ProvidersWsfedList(ctx).AcsUrl(acsUrl).AssertionValidNotBefore(assertionValidNotBefore).AssertionValidNotOnOrAfter(assertionValidNotOnOrAfter).Audience(audience).AuthenticationFlow(authenticationFlow).AuthnContextClassRefMapping(authnContextClassRefMapping).AuthorizationFlow(authorizationFlow).BackchannelApplication(backchannelApplication).DefaultNameIdPolicy(defaultNameIdPolicy).DefaultRelayState(defaultRelayState).DigestAlgorithm(digestAlgorithm).EncryptionKp(encryptionKp).InvalidationFlow(invalidationFlow).IsBackchannel(isBackchannel).IssuerOverride(issuerOverride).LogoutMethod(logoutMethod).Name(name).NameIdMapping(nameIdMapping).Ordering(ordering).Page(page).PageSize(pageSize).PropertyMappings(propertyMappings).SamlVersion(samlVersion).Search(search).SessionValidNotOnOrAfter(sessionValidNotOnOrAfter).SignAssertion(signAssertion).SignLogoutRequest(signLogoutRequest).SignLogoutResponse(signLogoutResponse).SignResponse(signResponse).SignatureAlgorithm(signatureAlgorithm).SigningKp(signingKp).SlsBinding(slsBinding).SlsUrl(slsUrl).SpBinding(spBinding).VerificationKp(verificationKp).Execute()
...
func main() {
	...
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
	propertyMappings := []string{"Inner_example"} // []string |  (optional)
	samlVersion := openapiclient.SamlVersionEnum("1.1") // SamlVersionEnum |  (optional)
	search := "search_example" // string | A search term. (optional)
	sessionValidNotOnOrAfter := "sessionValidNotOnOrAfter_example" // string |  (optional)
	signAssertion := true // bool |  (optional)
	signLogoutRequest := true // bool |  (optional)
 ...
 **pageSize** | **int32** | Number of results to return per page. | 
 **propertyMappings** | **[]string** |  | 
 **samlVersion** | [**SamlVersionEnum**](SamlVersionEnum.md) |  | 
 **search** | **string** | A search term. | 
 **sessionValidNotOnOrAfter** | **string** |  | 
 **signAssertion** | **bool** |  | 
 **signLogoutRequest** | **bool** |  | 
