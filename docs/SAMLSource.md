...
**UrlIssuer** | **string** | Get the resolved Issuer, falling back to the metadata URL when unset | [readonly] 
...
`func NewSAMLSource(pk string, name string, slug string, component string, verboseName string, verboseNamePlural string, metaModelName string, managed NullableString, iconUrl string, iconThemedUrls NullableThemedUrls, preAuthenticationFlow string, urlIssuer string, ssoUrl string, ) *SAMLSource`
...
`func (o *SAMLSource) GetIssuerOverride() string`

GetIssuerOverride returns the IssuerOverride field if non-nil, zero value otherwise.

### GetIssuerOverrideOk

`func (o *SAMLSource) GetIssuerOverrideOk() (*string, bool)`
...
`func (o *SAMLSource) SetIssuerOverride(v string)`

SetIssuerOverride sets IssuerOverride field to given value.

### HasIssuerOverride

`func (o *SAMLSource) HasIssuerOverride() bool`

HasIssuerOverride returns a boolean if a field has been set.

### GetUrlIssuer

`func (o *SAMLSource) GetUrlIssuer() string`

GetUrlIssuer returns the UrlIssuer field if non-nil, zero value otherwise.

### GetUrlIssuerOk

`func (o *SAMLSource) GetUrlIssuerOk() (*string, bool)`

GetUrlIssuerOk returns a tuple with the UrlIssuer field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetUrlIssuer

`func (o *SAMLSource) SetUrlIssuer(v string)`

SetUrlIssuer sets UrlIssuer field to given value.
