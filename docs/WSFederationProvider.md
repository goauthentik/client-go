...
`func (o *WSFederationProvider) GetSamlVersion() SamlVersionEnum`

GetSamlVersion returns the SamlVersion field if non-nil, zero value otherwise.

### GetSamlVersionOk

`func (o *WSFederationProvider) GetSamlVersionOk() (*SamlVersionEnum, bool)`
...
`func (o *WSFederationProvider) SetSamlVersion(v SamlVersionEnum)`

SetSamlVersion sets SamlVersion field to given value.

### HasSamlVersion

`func (o *WSFederationProvider) HasSamlVersion() bool`
...
`func (o *WSFederationProvider) GetUrlIssuer() string`

GetUrlIssuer returns the UrlIssuer field if non-nil, zero value otherwise.

### GetUrlIssuerOk

`func (o *WSFederationProvider) GetUrlIssuerOk() (*string, bool)`
...
`func (o *WSFederationProvider) SetUrlIssuer(v string)`
