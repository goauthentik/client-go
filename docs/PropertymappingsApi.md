...
> OAuthSourcePropertyMapping PropertymappingsSourceOauthCreate(ctx).OAuthSourcePropertyMappingRequest(oAuthSourcePropertyMappingRequest).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceOauthCreateRequest struct via the builder pattern
...
> PropertymappingsSourceOauthDestroy(ctx, pmUuid).Execute()
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**pmUuid** | **string** | A UUID string identifying this OAuth Source Property Mapping. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPropertymappingsSourceOauthDestroyRequest struct via the builder pattern
...
> PaginatedOAuthSourcePropertyMappingList PropertymappingsSourceOauthList(ctx).Managed(managed).ManagedIsnull(managedIsnull).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceOauthListRequest struct via the builder pattern
...
> OAuthSourcePropertyMapping PropertymappingsSourceOauthPartialUpdate(ctx, pmUuid).PatchedOAuthSourcePropertyMappingRequest(patchedOAuthSourcePropertyMappingRequest).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceOauthPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedOAuthSourcePropertyMappingRequest** | [**PatchedOAuthSourcePropertyMappingRequest**](PatchedOAuthSourcePropertyMappingRequest.md) |  | 
...
> OAuthSourcePropertyMapping PropertymappingsSourceOauthRetrieve(ctx, pmUuid).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceOauthRetrieveRequest struct via the builder pattern
...
> OAuthSourcePropertyMapping PropertymappingsSourceOauthUpdate(ctx, pmUuid).OAuthSourcePropertyMappingRequest(oAuthSourcePropertyMappingRequest).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceOauthUpdateRequest struct via the builder pattern
...
> []UsedBy PropertymappingsSourceOauthUsedByList(ctx, pmUuid).Execute()
...
> SAMLSourcePropertyMapping PropertymappingsSourceSamlCreate(ctx).SAMLSourcePropertyMappingRequest(sAMLSourcePropertyMappingRequest).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceSamlCreateRequest struct via the builder pattern
...
> PropertymappingsSourceSamlDestroy(ctx, pmUuid).Execute()
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**pmUuid** | **string** | A UUID string identifying this SAML Source Property Mapping. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPropertymappingsSourceSamlDestroyRequest struct via the builder pattern
...
> PaginatedSAMLSourcePropertyMappingList PropertymappingsSourceSamlList(ctx).Managed(managed).ManagedIsnull(managedIsnull).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceSamlListRequest struct via the builder pattern
...
> SAMLSourcePropertyMapping PropertymappingsSourceSamlPartialUpdate(ctx, pmUuid).PatchedSAMLSourcePropertyMappingRequest(patchedSAMLSourcePropertyMappingRequest).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceSamlPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedSAMLSourcePropertyMappingRequest** | [**PatchedSAMLSourcePropertyMappingRequest**](PatchedSAMLSourcePropertyMappingRequest.md) |  | 
...
> SAMLSourcePropertyMapping PropertymappingsSourceSamlRetrieve(ctx, pmUuid).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceSamlRetrieveRequest struct via the builder pattern
...
> SAMLSourcePropertyMapping PropertymappingsSourceSamlUpdate(ctx, pmUuid).SAMLSourcePropertyMappingRequest(sAMLSourcePropertyMappingRequest).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceSamlUpdateRequest struct via the builder pattern
...
> []UsedBy PropertymappingsSourceSamlUsedByList(ctx, pmUuid).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceSamlUsedByListRequest struct via the builder pattern
...
> SCIMSourcePropertyMapping PropertymappingsSourceScimCreate(ctx).SCIMSourcePropertyMappingRequest(sCIMSourcePropertyMappingRequest).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceScimCreateRequest struct via the builder pattern
...
> PropertymappingsSourceScimDestroy(ctx, pmUuid).Execute()
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**pmUuid** | **string** | A UUID string identifying this SCIM Source Property Mapping. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPropertymappingsSourceScimDestroyRequest struct via the builder pattern
...
> PaginatedSCIMSourcePropertyMappingList PropertymappingsSourceScimList(ctx).Managed(managed).ManagedIsnull(managedIsnull).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceScimListRequest struct via the builder pattern
...
> SCIMSourcePropertyMapping PropertymappingsSourceScimPartialUpdate(ctx, pmUuid).PatchedSCIMSourcePropertyMappingRequest(patchedSCIMSourcePropertyMappingRequest).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceScimPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedSCIMSourcePropertyMappingRequest** | [**PatchedSCIMSourcePropertyMappingRequest**](PatchedSCIMSourcePropertyMappingRequest.md) |  | 
...
> SCIMSourcePropertyMapping PropertymappingsSourceScimRetrieve(ctx, pmUuid).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceScimRetrieveRequest struct via the builder pattern
...
> SCIMSourcePropertyMapping PropertymappingsSourceScimUpdate(ctx, pmUuid).SCIMSourcePropertyMappingRequest(sCIMSourcePropertyMappingRequest).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceScimUpdateRequest struct via the builder pattern
...
> []UsedBy PropertymappingsSourceScimUsedByList(ctx, pmUuid).Execute()
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceScimUsedByListRequest struct via the builder pattern
...
> TelegramSourcePropertyMapping PropertymappingsSourceTelegramCreate(ctx).TelegramSourcePropertyMappingRequest(telegramSourcePropertyMappingRequest).Execute()
...
func main() {
    telegramSourcePropertyMappingRequest := *openapiclient.NewTelegramSourcePropertyMappingRequest("Name_example", "Expression_example") // TelegramSourcePropertyMappingRequest | 

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PropertymappingsApi.PropertymappingsSourceTelegramCreate(context.Background()).TelegramSourcePropertyMappingRequest(telegramSourcePropertyMappingRequest).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PropertymappingsApi.PropertymappingsSourceTelegramCreate``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PropertymappingsSourceTelegramCreate`: TelegramSourcePropertyMapping
    fmt.Fprintf(os.Stdout, "Response from `PropertymappingsApi.PropertymappingsSourceTelegramCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceTelegramCreateRequest struct via the builder pattern
...
> PropertymappingsSourceTelegramDestroy(ctx, pmUuid).Execute()
...
func main() {
    pmUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this Telegram Source Property Mapping.

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PropertymappingsApi.PropertymappingsSourceTelegramDestroy(context.Background(), pmUuid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PropertymappingsApi.PropertymappingsSourceTelegramDestroy``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**pmUuid** | **string** | A UUID string identifying this Telegram Source Property Mapping. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPropertymappingsSourceTelegramDestroyRequest struct via the builder pattern
...
> PaginatedTelegramSourcePropertyMappingList PropertymappingsSourceTelegramList(ctx).Managed(managed).ManagedIsnull(managedIsnull).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PropertymappingsApi.PropertymappingsSourceTelegramList(context.Background()).Managed(managed).ManagedIsnull(managedIsnull).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PropertymappingsApi.PropertymappingsSourceTelegramList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PropertymappingsSourceTelegramList`: PaginatedTelegramSourcePropertyMappingList
    fmt.Fprintf(os.Stdout, "Response from `PropertymappingsApi.PropertymappingsSourceTelegramList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceTelegramListRequest struct via the builder pattern
...
> TelegramSourcePropertyMapping PropertymappingsSourceTelegramPartialUpdate(ctx, pmUuid).PatchedTelegramSourcePropertyMappingRequest(patchedTelegramSourcePropertyMappingRequest).Execute()
...
func main() {
    pmUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this Telegram Source Property Mapping.
    patchedTelegramSourcePropertyMappingRequest := *openapiclient.NewPatchedTelegramSourcePropertyMappingRequest() // PatchedTelegramSourcePropertyMappingRequest |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PropertymappingsApi.PropertymappingsSourceTelegramPartialUpdate(context.Background(), pmUuid).PatchedTelegramSourcePropertyMappingRequest(patchedTelegramSourcePropertyMappingRequest).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PropertymappingsApi.PropertymappingsSourceTelegramPartialUpdate``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PropertymappingsSourceTelegramPartialUpdate`: TelegramSourcePropertyMapping
    fmt.Fprintf(os.Stdout, "Response from `PropertymappingsApi.PropertymappingsSourceTelegramPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceTelegramPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedTelegramSourcePropertyMappingRequest** | [**PatchedTelegramSourcePropertyMappingRequest**](PatchedTelegramSourcePropertyMappingRequest.md) |  | 
...
> TelegramSourcePropertyMapping PropertymappingsSourceTelegramRetrieve(ctx, pmUuid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PropertymappingsApi.PropertymappingsSourceTelegramRetrieve(context.Background(), pmUuid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PropertymappingsApi.PropertymappingsSourceTelegramRetrieve``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PropertymappingsSourceTelegramRetrieve`: TelegramSourcePropertyMapping
    fmt.Fprintf(os.Stdout, "Response from `PropertymappingsApi.PropertymappingsSourceTelegramRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceTelegramRetrieveRequest struct via the builder pattern
...
> TelegramSourcePropertyMapping PropertymappingsSourceTelegramUpdate(ctx, pmUuid).TelegramSourcePropertyMappingRequest(telegramSourcePropertyMappingRequest).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PropertymappingsApi.PropertymappingsSourceTelegramUpdate(context.Background(), pmUuid).TelegramSourcePropertyMappingRequest(telegramSourcePropertyMappingRequest).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PropertymappingsApi.PropertymappingsSourceTelegramUpdate``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PropertymappingsSourceTelegramUpdate`: TelegramSourcePropertyMapping
    fmt.Fprintf(os.Stdout, "Response from `PropertymappingsApi.PropertymappingsSourceTelegramUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceTelegramUpdateRequest struct via the builder pattern
...
> []UsedBy PropertymappingsSourceTelegramUsedByList(ctx, pmUuid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PropertymappingsApi.PropertymappingsSourceTelegramUsedByList(context.Background(), pmUuid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PropertymappingsApi.PropertymappingsSourceTelegramUsedByList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PropertymappingsSourceTelegramUsedByList`: []UsedBy
    fmt.Fprintf(os.Stdout, "Response from `PropertymappingsApi.PropertymappingsSourceTelegramUsedByList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPropertymappingsSourceTelegramUsedByListRequest struct via the builder pattern
