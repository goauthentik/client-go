...
**Expiring** | **bool** |  | [readonly] 

## Methods

### NewPolicyBinding

`func NewPolicyBinding(pk string, policyObj NullablePolicy, groupObj NullablePartialGroup, userObj NullablePartialUser, target string, order int32, expires NullableTime, expiring bool, ) *PolicyBinding`
...
`func (o *PolicyBinding) GetExpires() time.Time`

GetExpires returns the Expires field if non-nil, zero value otherwise.

### GetExpiresOk

`func (o *PolicyBinding) GetExpiresOk() (*time.Time, bool)`
...
`func (o *PolicyBinding) SetExpires(v time.Time)`
...
`func (o *PolicyBinding) SetExpiresNil(b bool)`

 SetExpiresNil sets the value for Expires to be an explicit nil

### UnsetExpires
`func (o *PolicyBinding) UnsetExpires()`

UnsetExpires ensures that no value is present for Expires, not even an explicit nil
### GetExpiring

`func (o *PolicyBinding) GetExpiring() bool`

GetExpiring returns the Expiring field if non-nil, zero value otherwise.

### GetExpiringOk

`func (o *PolicyBinding) GetExpiringOk() (*bool, bool)`
...
`func (o *PolicyBinding) SetExpiring(v bool)`
