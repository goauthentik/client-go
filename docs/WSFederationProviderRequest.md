...
`func (o *WSFederationProviderRequest) GetSamlVersion() SamlVersionEnum`

GetSamlVersion returns the SamlVersion field if non-nil, zero value otherwise.

### GetSamlVersionOk

`func (o *WSFederationProviderRequest) GetSamlVersionOk() (*SamlVersionEnum, bool)`
...
`func (o *WSFederationProviderRequest) SetSamlVersion(v SamlVersionEnum)`

SetSamlVersion sets SamlVersion field to given value.

### HasSamlVersion

`func (o *WSFederationProviderRequest) HasSamlVersion() bool`
