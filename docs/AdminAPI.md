...
func main() {
	name := "name_example" // string |  (optional)
	usage := openapiclient.UsageEnum("media") // UsageEnum |  (optional) (default to "media")
...
------------- | ------------- | ------------- | -------------
 **name** | **string** |  | 
 **usage** | [**UsageEnum**](UsageEnum.md) |  | [default to &quot;media&quot;]
...
> []App AdminModelsList(ctx).FilterHasAttributes(filterHasAttributes).Execute()
...
func main() {
	filterHasAttributes := true // bool |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AdminAPI.AdminModelsList(context.Background()).FilterHasAttributes(filterHasAttributes).Execute()
	if err != nil {
...
func main() {
	settingsRequest := *openapiclient.NewSettingsRequest(*openapiclient.NewPatchedSettingsRequestFlags(false, false, false, false)) // SettingsRequest | 
