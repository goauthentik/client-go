...
**PreventDuplicateDevices** | Pointer to **bool** | When enabled, a given device can only be registered once. | [optional] 
...
### GetPreventDuplicateDevices

`func (o *AuthenticatorWebAuthnStage) GetPreventDuplicateDevices() bool`

GetPreventDuplicateDevices returns the PreventDuplicateDevices field if non-nil, zero value otherwise.

### GetPreventDuplicateDevicesOk

`func (o *AuthenticatorWebAuthnStage) GetPreventDuplicateDevicesOk() (*bool, bool)`

GetPreventDuplicateDevicesOk returns a tuple with the PreventDuplicateDevices field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetPreventDuplicateDevices

`func (o *AuthenticatorWebAuthnStage) SetPreventDuplicateDevices(v bool)`

SetPreventDuplicateDevices sets PreventDuplicateDevices field to given value.

### HasPreventDuplicateDevices
