...
**MetaHide** | Pointer to **bool** | Hide this application from the user&#39;s My applications page. | [optional] 

## Methods

### NewApplication

`func NewApplication(pk string, pbmUuid string, name string, slug string, providerObj NullableProvider, backchannelProvidersObj []Provider, launchUrl NullableString, metaIconUrl NullableString, metaIconThemedUrls NullableThemedUrls, ) *Application`
...
`func (o *Application) GetPbmUuid() string`

GetPbmUuid returns the PbmUuid field if non-nil, zero value otherwise.

### GetPbmUuidOk

`func (o *Application) GetPbmUuidOk() (*string, bool)`
...
`func (o *Application) SetPbmUuid(v string)`
...
`func (o *Application) GetMetaHide() bool`

GetMetaHide returns the MetaHide field if non-nil, zero value otherwise.

### GetMetaHideOk

`func (o *Application) GetMetaHideOk() (*bool, bool)`

GetMetaHideOk returns a tuple with the MetaHide field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetMetaHide

`func (o *Application) SetMetaHide(v bool)`

SetMetaHide sets MetaHide field to given value.

### HasMetaHide

`func (o *Application) HasMetaHide() bool`

HasMetaHide returns a boolean if a field has been set.
