...
**DcrRegistration** | **NullableString** |  | [readonly] 

## Methods

### NewOAuth2ProviderSetupURLs

`func NewOAuth2ProviderSetupURLs(issuer string, authorize string, token string, userInfo string, providerInfo string, logout string, jwks string, dcrRegistration NullableString, ) *OAuth2ProviderSetupURLs`
...
`func (o *OAuth2ProviderSetupURLs) GetDcrRegistration() string`

GetDcrRegistration returns the DcrRegistration field if non-nil, zero value otherwise.

### GetDcrRegistrationOk

`func (o *OAuth2ProviderSetupURLs) GetDcrRegistrationOk() (*string, bool)`
...
`func (o *OAuth2ProviderSetupURLs) SetDcrRegistration(v string)`

SetDcrRegistration sets DcrRegistration field to given value.


### SetDcrRegistrationNil

`func (o *OAuth2ProviderSetupURLs) SetDcrRegistrationNil(b bool)`

 SetDcrRegistrationNil sets the value for DcrRegistration to be an explicit nil

### UnsetDcrRegistration
`func (o *OAuth2ProviderSetupURLs) UnsetDcrRegistration()`

UnsetDcrRegistration ensures that no value is present for DcrRegistration, not even an explicit nil
