...
`func NewReview(id string, iteration string, reviewer PartialUser, timestamp time.Time, ) *Review`
...
`func (o *Review) GetReviewer() PartialUser`

GetReviewer returns the Reviewer field if non-nil, zero value otherwise.

### GetReviewerOk

`func (o *Review) GetReviewerOk() (*PartialUser, bool)`
...
`func (o *Review) SetReviewer(v PartialUser)`
