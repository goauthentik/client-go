...
[**EventsEventsStatsRetrieve**](EventsAPI.md#EventsEventsStatsRetrieve) | **Get** /events/events/stats/ | 
...
> DataExport EventsEventsExportCreate(ctx).Action(action).Actions(actions).BrandName(brandName).ClientIp(clientIp).ContextAuthorizedApp(contextAuthorizedApp).ContextDevice(contextDevice).ContextModelApp(contextModelApp).ContextModelName(contextModelName).ContextModelPk(contextModelPk).Ordering(ordering).Search(search).Username(username).Execute()
...
func main() {
	...
	actions := []openapiclient.EventActions{openapiclient.EventActions("login")} // []EventActions |  (optional)
	...
	contextDevice := "contextDevice_example" // string | Context Device Primary Key (optional)
...
------------- | ------------- | ------------- | -------------
 **action** | **string** |  | 
 **actions** | [**[]EventActions**](EventActions.md) |  | 
 **brandName** | **string** | Brand name | 
 **clientIp** | **string** |  | 
 **contextAuthorizedApp** | **string** | Context Authorized application | 
 **contextDevice** | **string** | Context Device Primary Key | 
...
> PaginatedEventList EventsEventsList(ctx).Action(action).Actions(actions).BrandName(brandName).ClientIp(clientIp).ContextAuthorizedApp(contextAuthorizedApp).ContextDevice(contextDevice).ContextModelApp(contextModelApp).ContextModelName(contextModelName).ContextModelPk(contextModelPk).Ordering(ordering).Page(page).PageSize(pageSize).Search(search).Username(username).Execute()
...
> EventStats EventsEventsStatsRetrieve(ctx).CountSteps(countSteps).Action(action).Actions(actions).BrandName(brandName).ClientIp(clientIp).ContextAuthorizedApp(contextAuthorizedApp).ContextDevice(contextDevice).ContextModelApp(contextModelApp).ContextModelName(contextModelName).ContextModelPk(contextModelPk).Ordering(ordering).Search(search).Username(username).Execute()
...
func main() {
	countSteps := []string{"Inner_example"} // []string | Timedelta, format of 'weeks=3;days=2;hours=3,seconds=2'
	action := "action_example" // string |  (optional)
	actions := []openapiclient.EventActions{openapiclient.EventActions("login")} // []EventActions |  (optional)
	brandName := "brandName_example" // string | Brand name (optional)
	clientIp := "clientIp_example" // string |  (optional)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.EventsAPI.EventsEventsStatsRetrieve(context.Background()).CountSteps(countSteps).Action(action).Actions(actions).BrandName(brandName).ClientIp(clientIp).ContextAuthorizedApp(contextAuthorizedApp).ContextDevice(contextDevice).ContextModelApp(contextModelApp).ContextModelName(contextModelName).ContextModelPk(contextModelPk).Ordering(ordering).Search(search).Username(username).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `EventsAPI.EventsEventsStatsRetrieve``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `EventsEventsStatsRetrieve`: EventStats
	fmt.Fprintf(os.Stdout, "Response from `EventsAPI.EventsEventsStatsRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiEventsEventsStatsRetrieveRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **countSteps** | **[]string** | Timedelta, format of &#39;weeks&#x3D;3;days&#x3D;2;hours&#x3D;3,seconds&#x3D;2&#39; | 
 **action** | **string** |  | 
 **actions** | [**[]EventActions**](EventActions.md) |  | 
 **brandName** | **string** | Brand name | 
 **clientIp** | **string** |  | 
...
> []EventTopPerUser EventsEventsTopPerUserList(ctx).Action(action).Actions(actions).BrandName(brandName).ClientIp(clientIp).ContextAuthorizedApp(contextAuthorizedApp).ContextDevice(contextDevice).ContextModelApp(contextModelApp).ContextModelName(contextModelName).ContextModelPk(contextModelPk).Ordering(ordering).Search(search).TopN(topN).Username(username).Execute()
...
func main() {
	...
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	search := "search_example" // string | A search term. (optional)
	topN := int32(56) // int32 |  (optional) (default to 15)
	username := "username_example" // string | Username (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.EventsAPI.EventsEventsTopPerUserList(context.Background()).Action(action).Actions(actions).BrandName(brandName).ClientIp(clientIp).ContextAuthorizedApp(contextAuthorizedApp).ContextDevice(contextDevice).ContextModelApp(contextModelApp).ContextModelName(contextModelName).ContextModelPk(contextModelPk).Ordering(ordering).Search(search).TopN(topN).Username(username).Execute()
	if err != nil {
...
> []EventVolume EventsEventsVolumeList(ctx).Action(action).Actions(actions).BrandName(brandName).ClientIp(clientIp).ContextAuthorizedApp(contextAuthorizedApp).ContextDevice(contextDevice).ContextModelApp(contextModelApp).ContextModelName(contextModelName).ContextModelPk(contextModelPk).HistoryDays(historyDays).Ordering(ordering).Search(search).Username(username).Execute()
...
func main() {
	...
	contextModelName := "contextModelName_example" // string | Context Model Name (optional)
	contextModelPk := "contextModelPk_example" // string | Context Model Primary Key (optional)
	historyDays := int32(56) // int32 |  (optional) (default to 7)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	search := "search_example" // string | A search term. (optional)
	username := "username_example" // string | Username (optional)
 ...
 **contextModelName** | **string** | Context Model Name | 
 **contextModelPk** | **string** | Context Model Primary Key | 
 **historyDays** | **int32** |  | [default to 7]
 **ordering** | **string** | Which field to use when ordering the results. | 
 **search** | **string** | A search term. | 
 **username** | **string** | Username | 
...
func main() {
	...
	severity := openapiclient.SeverityEnum("notice") // SeverityEnum |  (optional)
...
func main() {
	mode := openapiclient.TransportModeEnum("local") // TransportModeEnum |  (optional)
	name := "name_example" // string |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
