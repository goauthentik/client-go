...
func main() {
	...
	invalidResponseAction := openapiclient.InvalidResponseActionEnum("retry") // InvalidResponseActionEnum |  (optional)
	...
	policyEngineMode := openapiclient.PolicyEngineMode("all") // PolicyEngineMode |  (optional)
...
func main() {
	deniedAction := openapiclient.DeniedActionEnum("message_continue") // DeniedActionEnum |  (optional)
	designation := openapiclient.FlowDesignationEnum("authentication") // FlowDesignationEnum |  (optional)
