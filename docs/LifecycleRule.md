...
**ReviewerGroupsObj** | [**[]PartialGroup**](PartialGroup.md) |  | [readonly] 
**MinReviewers** | Pointer to **int32** |  | [optional] 
**MinReviewersIsPerGroup** | Pointer to **bool** |  | [optional] 
**Reviewers** | **[]string** |  | 
**ReviewersObj** | [**[]PartialUser**](PartialUser.md) |  | [readonly] 
...
`func NewLifecycleRule(id string, name string, contentType ContentTypeEnum, reviewerGroupsObj []PartialGroup, reviewers []string, reviewersObj []PartialUser, targetVerbose string, ) *LifecycleRule`
...
`func (o *LifecycleRule) GetReviewerGroupsObj() []PartialGroup`

GetReviewerGroupsObj returns the ReviewerGroupsObj field if non-nil, zero value otherwise.

### GetReviewerGroupsObjOk

`func (o *LifecycleRule) GetReviewerGroupsObjOk() (*[]PartialGroup, bool)`
...
`func (o *LifecycleRule) SetReviewerGroupsObj(v []PartialGroup)`
...
`func (o *LifecycleRule) GetReviewersObj() []PartialUser`

GetReviewersObj returns the ReviewersObj field if non-nil, zero value otherwise.

### GetReviewersObjOk

`func (o *LifecycleRule) GetReviewersObjOk() (*[]PartialUser, bool)`
...
`func (o *LifecycleRule) SetReviewersObj(v []PartialUser)`
