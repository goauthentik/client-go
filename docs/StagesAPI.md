...
------------- | ------------- | -------------
[**StagesAccountLockdownCreate**](StagesAPI.md#StagesAccountLockdownCreate) | **Post** /stages/account_lockdown/ | 
[**StagesAccountLockdownDestroy**](StagesAPI.md#StagesAccountLockdownDestroy) | **Delete** /stages/account_lockdown/{stage_uuid}/ | 
[**StagesAccountLockdownList**](StagesAPI.md#StagesAccountLockdownList) | **Get** /stages/account_lockdown/ | 
[**StagesAccountLockdownPartialUpdate**](StagesAPI.md#StagesAccountLockdownPartialUpdate) | **Patch** /stages/account_lockdown/{stage_uuid}/ | 
[**StagesAccountLockdownRetrieve**](StagesAPI.md#StagesAccountLockdownRetrieve) | **Get** /stages/account_lockdown/{stage_uuid}/ | 
[**StagesAccountLockdownUpdate**](StagesAPI.md#StagesAccountLockdownUpdate) | **Put** /stages/account_lockdown/{stage_uuid}/ | 
[**StagesAccountLockdownUsedByList**](StagesAPI.md#StagesAccountLockdownUsedByList) | **Get** /stages/account_lockdown/{stage_uuid}/used_by/ | 
...
## StagesAccountLockdownCreate

> AccountLockdownStage StagesAccountLockdownCreate(ctx).AccountLockdownStageRequest(accountLockdownStageRequest).Execute()
...
func main() {
	accountLockdownStageRequest := *openapiclient.NewAccountLockdownStageRequest("Name_example") // AccountLockdownStageRequest | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.StagesAPI.StagesAccountLockdownCreate(context.Background()).AccountLockdownStageRequest(accountLockdownStageRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `StagesAPI.StagesAccountLockdownCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `StagesAccountLockdownCreate`: AccountLockdownStage
	fmt.Fprintf(os.Stdout, "Response from `StagesAPI.StagesAccountLockdownCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesAccountLockdownCreateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **accountLockdownStageRequest** | [**AccountLockdownStageRequest**](AccountLockdownStageRequest.md) |  | 
...
> StagesAccountLockdownDestroy(ctx, stageUuid).Execute()
...
func main() {
	stageUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this Account Lockdown Stage.

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.StagesAPI.StagesAccountLockdownDestroy(context.Background(), stageUuid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `StagesAPI.StagesAccountLockdownDestroy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
**stageUuid** | **string** | A UUID string identifying this Account Lockdown Stage. | 

### Other Parameters

Other parameters are passed through a pointer to a apiStagesAccountLockdownDestroyRequest struct via the builder pattern
...
## StagesAccountLockdownList

> PaginatedAccountLockdownStageList StagesAccountLockdownList(ctx).DeactivateUser(deactivateUser).DeleteSessions(deleteSessions).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).RevokeTokens(revokeTokens).Search(search).SelfServiceCompletionFlow(selfServiceCompletionFlow).SetUnusablePassword(setUnusablePassword).StageUuid(stageUuid).Execute()
...
func main() {
	deactivateUser := true // bool |  (optional)
	deleteSessions := true // bool |  (optional)
	name := "name_example" // string |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
	revokeTokens := true // bool |  (optional)
	search := "search_example" // string | A search term. (optional)
	selfServiceCompletionFlow := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
	setUnusablePassword := true // bool |  (optional)
	stageUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.StagesAPI.StagesAccountLockdownList(context.Background()).DeactivateUser(deactivateUser).DeleteSessions(deleteSessions).Name(name).Ordering(ordering).Page(page).PageSize(pageSize).RevokeTokens(revokeTokens).Search(search).SelfServiceCompletionFlow(selfServiceCompletionFlow).SetUnusablePassword(setUnusablePassword).StageUuid(stageUuid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `StagesAPI.StagesAccountLockdownList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `StagesAccountLockdownList`: PaginatedAccountLockdownStageList
	fmt.Fprintf(os.Stdout, "Response from `StagesAPI.StagesAccountLockdownList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesAccountLockdownListRequest struct via the builder pattern
...
> AccountLockdownStage StagesAccountLockdownPartialUpdate(ctx, stageUuid).PatchedAccountLockdownStageRequest(patchedAccountLockdownStageRequest).Execute()
...
func main() {
	stageUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this Account Lockdown Stage.
	patchedAccountLockdownStageRequest := *openapiclient.NewPatchedAccountLockdownStageRequest() // PatchedAccountLockdownStageRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.StagesAPI.StagesAccountLockdownPartialUpdate(context.Background(), stageUuid).PatchedAccountLockdownStageRequest(patchedAccountLockdownStageRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `StagesAPI.StagesAccountLockdownPartialUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `StagesAccountLockdownPartialUpdate`: AccountLockdownStage
	fmt.Fprintf(os.Stdout, "Response from `StagesAPI.StagesAccountLockdownPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesAccountLockdownPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedAccountLockdownStageRequest** | [**PatchedAccountLockdownStageRequest**](PatchedAccountLockdownStageRequest.md) |  | 
...
## StagesAccountLockdownRetrieve

> AccountLockdownStage StagesAccountLockdownRetrieve(ctx, stageUuid).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.StagesAPI.StagesAccountLockdownRetrieve(context.Background(), stageUuid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `StagesAPI.StagesAccountLockdownRetrieve``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `StagesAccountLockdownRetrieve`: AccountLockdownStage
	fmt.Fprintf(os.Stdout, "Response from `StagesAPI.StagesAccountLockdownRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesAccountLockdownRetrieveRequest struct via the builder pattern
...
## StagesAccountLockdownUpdate

> AccountLockdownStage StagesAccountLockdownUpdate(ctx, stageUuid).AccountLockdownStageRequest(accountLockdownStageRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.StagesAPI.StagesAccountLockdownUpdate(context.Background(), stageUuid).AccountLockdownStageRequest(accountLockdownStageRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `StagesAPI.StagesAccountLockdownUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `StagesAccountLockdownUpdate`: AccountLockdownStage
	fmt.Fprintf(os.Stdout, "Response from `StagesAPI.StagesAccountLockdownUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesAccountLockdownUpdateRequest struct via the builder pattern
...
## StagesAccountLockdownUsedByList

> []UsedBy StagesAccountLockdownUsedByList(ctx, stageUuid).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.StagesAPI.StagesAccountLockdownUsedByList(context.Background(), stageUuid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `StagesAPI.StagesAccountLockdownUsedByList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `StagesAccountLockdownUsedByList`: []UsedBy
	fmt.Fprintf(os.Stdout, "Response from `StagesAPI.StagesAccountLockdownUsedByList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStagesAccountLockdownUsedByListRequest struct via the builder pattern
...
func main() {
	...
	authType := openapiclient.AuthTypeEnum("basic") // AuthTypeEnum |  (optional)
	configureFlow := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
	friendlyName := "friendlyName_example" // string |  (optional)
	...
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
	provider := openapiclient.ProviderEnum("twilio") // ProviderEnum |  (optional)
	search := "search_example" // string | A search term. (optional)
	stageUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
...
func main() {
	configureFlow := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
	digits := openapiclient.DigitsEnum("6") // DigitsEnum |  (optional)
	friendlyName := "friendlyName_example" // string |  (optional)
	name := "name_example" // string |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
...
func main() {
	...
	name := "name_example" // string |  (optional)
	notConfiguredAction := openapiclient.NotConfiguredActionEnum("skip") // NotConfiguredActionEnum |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
	search := "search_example" // string | A search term. (optional)
...
func main() {
	authenticatorAttachment := openapiclient.AuthenticatorAttachmentEnum("platform") // AuthenticatorAttachmentEnum |  (optional)
	configureFlow := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
	...
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
	residentKeyRequirement := openapiclient.UserVerificationEnum("required") // UserVerificationEnum |  (optional)
	search := "search_example" // string | A search term. (optional)
	userVerification := openapiclient.UserVerificationEnum("required") // UserVerificationEnum |  (optional)
...
func main() {
	...
	mode := openapiclient.ConsentModeEnum("always_require") // ConsentModeEnum |  (optional)
	name := "name_example" // string |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
 ...
 **mode** | [**ConsentModeEnum**](ConsentModeEnum.md) |  | 
 **name** | **string** |  | 
 **ordering** | **string** | Which field to use when ordering the results. | 
 **page** | **int32** | A page number within the paginated result set. | 
 **pageSize** | **int32** | Number of results to return per page. | 
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.StagesAPI.StagesEndpointsDestroy(context.Background(), stageUuid).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.StagesAPI.StagesMtlsDestroy(context.Background(), stageUuid).Execute()
	if err != nil {
...
func main() {
	certAttribute := openapiclient.CertAttributeEnum("subject") // CertAttributeEnum |  (optional)
	certificateAuthorities := []string{"Inner_example"} // []string |  (optional)
	mode := openapiclient.StageModeEnum("optional") // StageModeEnum |  (optional)
	name := "name_example" // string |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
	search := "search_example" // string | A search term. (optional)
	stageUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
	userAttribute := openapiclient.UserAttributeEnum("username") // UserAttributeEnum |  (optional)
...
func main() {
	...
	search := "search_example" // string | A search term. (optional)
	type_ := openapiclient.PromptTypeEnum("text") // PromptTypeEnum |  (optional)
 ...
 **placeholder** | **string** |  | 
 **search** | **string** | A search term. | 
 **type_** | [**PromptTypeEnum**](PromptTypeEnum.md) |  | 
...
func main() {
	geoipBinding := openapiclient.GeoipBindingEnum("no_binding") // GeoipBindingEnum |  (optional)
	name := "name_example" // string |  (optional)
	networkBinding := openapiclient.NetworkBindingEnum("no_binding") // NetworkBindingEnum |  (optional)
	ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
	page := int32(56) // int32 | A page number within the paginated result set. (optional)
	pageSize := int32(56) // int32 | Number of results to return per page. (optional)
...
func main() {
	...
	search := "search_example" // string | A search term. (optional)
	stageUuid := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
	userCreationMode := openapiclient.UserCreationModeEnum("never_create") // UserCreationModeEnum |  (optional)
	userPathTemplate := "userPathTemplate_example" // string |  (optional)
	userType := openapiclient.UserTypeEnum("internal") // UserTypeEnum |  (optional)
