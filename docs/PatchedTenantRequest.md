...
`func (o *PatchedTenantRequest) GetAttributes() interface{}`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *PatchedTenantRequest) GetAttributesOk() (*interface{}, bool)`
...
`func (o *PatchedTenantRequest) SetAttributes(v interface{})`
...
`func (o *PatchedTenantRequest) SetAttributesNil(b bool)`

 SetAttributesNil sets the value for Attributes to be an explicit nil

### UnsetAttributes
`func (o *PatchedTenantRequest) UnsetAttributes()`
