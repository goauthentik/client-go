...
`func (o *CaptchaStage) GetRequestContentType() RequestContentTypeEnum`

GetRequestContentType returns the RequestContentType field if non-nil, zero value otherwise.

### GetRequestContentTypeOk

`func (o *CaptchaStage) GetRequestContentTypeOk() (*RequestContentTypeEnum, bool)`
...
`func (o *CaptchaStage) SetRequestContentType(v RequestContentTypeEnum)`

SetRequestContentType sets RequestContentType field to given value.

### HasRequestContentType

`func (o *CaptchaStage) HasRequestContentType() bool`
