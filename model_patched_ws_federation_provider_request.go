...
type PatchedWSFederationProviderRequest struct {
	...
	SamlVersion        *SamlVersionEnum        `json:"saml_version,omitempty"`
...
func (o *PatchedWSFederationProviderRequest) GetSamlVersion() SamlVersionEnum {
	if o == nil || IsNil(o.SamlVersion) {
		var ret SamlVersionEnum
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PatchedWSFederationProviderRequest) GetSamlVersionOk() (*SamlVersionEnum, bool) {
	if o == nil || IsNil(o.SamlVersion) {
		return nil, false
	}
...
func (o *PatchedWSFederationProviderRequest) HasSamlVersion() bool {
	if o != nil && !IsNil(o.SamlVersion) {
		return true
	}
...
// SetSamlVersion gets a reference to the given SamlVersionEnum and assigns it to the SamlVersion field.
func (o *PatchedWSFederationProviderRequest) SetSamlVersion(v SamlVersionEnum) {
	o.SamlVersion = &v
}
...
func (o PatchedWSFederationProviderRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SamlVersion) {
		toSerialize["saml_version"] = o.SamlVersion
	}
...
func (o *PatchedWSFederationProviderRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PatchedWSFederationProviderRequest(varPatchedWSFederationProviderRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "saml_version")
