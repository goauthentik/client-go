...
type _PaginatedSAMLPropertyMappingList PaginatedSAMLPropertyMappingList
...
func (o *PaginatedSAMLPropertyMappingList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedSAMLPropertyMappingList := _PaginatedSAMLPropertyMappingList{}

	err = json.Unmarshal(data, &varPaginatedSAMLPropertyMappingList)

	if err != nil {
		return err
	}

	*o = PaginatedSAMLPropertyMappingList(varPaginatedSAMLPropertyMappingList)
...
type NullablePaginatedSAMLPropertyMappingList struct {
	value *PaginatedSAMLPropertyMappingList
	isSet bool
}

func (v NullablePaginatedSAMLPropertyMappingList) Get() *PaginatedSAMLPropertyMappingList {
	return v.value
}

func (v *NullablePaginatedSAMLPropertyMappingList) Set(val *PaginatedSAMLPropertyMappingList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedSAMLPropertyMappingList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedSAMLPropertyMappingList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedSAMLPropertyMappingList(val *PaginatedSAMLPropertyMappingList) *NullablePaginatedSAMLPropertyMappingList {
	return &NullablePaginatedSAMLPropertyMappingList{value: val, isSet: true}
}

func (v NullablePaginatedSAMLPropertyMappingList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedSAMLPropertyMappingList) UnmarshalJSON(src []byte) error {
	v.isSet = true
