...
const (
	...
	APPENUM_AUTHENTIK_ENTERPRISE_REQUESTS                           AppEnum = "authentik.enterprise.requests"
	APPENUM_AUTHENTIK_ENTERPRISE_STAGES_ACCOUNT_LOCKDOWN            AppEnum = "authentik.enterprise.stages.account_lockdown"
