...
// checks if the PatchedGoogleWorkspaceProviderMappingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedGoogleWorkspaceProviderMappingRequest{}
...
func (o PatchedGoogleWorkspaceProviderMappingRequest) ToMap() (map[string]interface{}, error) {
