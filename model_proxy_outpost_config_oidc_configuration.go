...
// ProxyOutpostConfigOidcConfiguration struct for ProxyOutpostConfigOidcConfiguration
type ProxyOutpostConfigOidcConfiguration struct {
...
func NewProxyOutpostConfigOidcConfiguration(issuer string, authorizationEndpoint string, tokenEndpoint string, userinfoEndpoint string, endSessionEndpoint string, introspectionEndpoint string, jwksUri string, responseTypesSupported []string, idTokenSigningAlgValuesSupported []string, subjectTypesSupported []string, tokenEndpointAuthMethodsSupported []string) *ProxyOutpostConfigOidcConfiguration {
	this := ProxyOutpostConfigOidcConfiguration{}
	this.Issuer = issuer
...
func (o ProxyOutpostConfigOidcConfiguration) MarshalJSON() ([]byte, error) {
...
type NullableProxyOutpostConfigOidcConfiguration struct {
	value *ProxyOutpostConfigOidcConfiguration
	isSet bool
}

func (v NullableProxyOutpostConfigOidcConfiguration) Get() *ProxyOutpostConfigOidcConfiguration {
	return v.value
}

func (v *NullableProxyOutpostConfigOidcConfiguration) Set(val *ProxyOutpostConfigOidcConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableProxyOutpostConfigOidcConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableProxyOutpostConfigOidcConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProxyOutpostConfigOidcConfiguration(val *ProxyOutpostConfigOidcConfiguration) *NullableProxyOutpostConfigOidcConfiguration {
	return &NullableProxyOutpostConfigOidcConfiguration{value: val, isSet: true}
}

func (v NullableProxyOutpostConfigOidcConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProxyOutpostConfigOidcConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
