...
// ApplicationProviderObj struct for ApplicationProviderObj
type ApplicationProviderObj struct {
	Pk   int32  `json:"pk"`
...
func (o *ApplicationProviderObj) SetAuthenticationFlowNil() {
...
func (o ApplicationProviderObj) MarshalJSON() ([]byte, error) {
...
type NullableApplicationProviderObj struct {
	value *ApplicationProviderObj
	isSet bool
}

func (v NullableApplicationProviderObj) Get() *ApplicationProviderObj {
	return v.value
}

func (v *NullableApplicationProviderObj) Set(val *ApplicationProviderObj) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationProviderObj) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationProviderObj) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationProviderObj(val *ApplicationProviderObj) *NullableApplicationProviderObj {
	return &NullableApplicationProviderObj{value: val, isSet: true}
}

func (v NullableApplicationProviderObj) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationProviderObj) UnmarshalJSON(src []byte) error {
	v.isSet = true
