...
// checks if the PaginatedAuthenticatorEndpointGDTCStageList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedAuthenticatorEndpointGDTCStageList{}
...
type _PaginatedAuthenticatorEndpointGDTCStageList PaginatedAuthenticatorEndpointGDTCStageList
...
func (o PaginatedAuthenticatorEndpointGDTCStageList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedAuthenticatorEndpointGDTCStageList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedAuthenticatorEndpointGDTCStageList := _PaginatedAuthenticatorEndpointGDTCStageList{}

	err = json.Unmarshal(data, &varPaginatedAuthenticatorEndpointGDTCStageList)

	if err != nil {
		return err
	}

	*o = PaginatedAuthenticatorEndpointGDTCStageList(varPaginatedAuthenticatorEndpointGDTCStageList)
