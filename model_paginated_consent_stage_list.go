...
// checks if the PaginatedConsentStageList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedConsentStageList{}
...
type _PaginatedConsentStageList PaginatedConsentStageList
...
func (o PaginatedConsentStageList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedConsentStageList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedConsentStageList := _PaginatedConsentStageList{}

	err = json.Unmarshal(data, &varPaginatedConsentStageList)

	if err != nil {
		return err
	}

	*o = PaginatedConsentStageList(varPaginatedConsentStageList)
