...
// checks if the PaginatedExtraUserObjectPermissionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedExtraUserObjectPermissionList{}
...
type _PaginatedExtraUserObjectPermissionList PaginatedExtraUserObjectPermissionList
...
func (o PaginatedExtraUserObjectPermissionList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedExtraUserObjectPermissionList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedExtraUserObjectPermissionList := _PaginatedExtraUserObjectPermissionList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaginatedExtraUserObjectPermissionList)

	if err != nil {
		return err
	}

	*o = PaginatedExtraUserObjectPermissionList(varPaginatedExtraUserObjectPermissionList)
