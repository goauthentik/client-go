...
const (
	NAMEIDPOLICYENUM_URN_OASIS_NAMES_TC_SAML_1_1_NAMEID_FORMAT_EMAIL_ADDRESS                 NameIdPolicyEnum = "urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress"
	NAMEIDPOLICYENUM_URN_OASIS_NAMES_TC_SAML_2_0_NAMEID_FORMAT_PERSISTENT                    NameIdPolicyEnum = "urn:oasis:names:tc:SAML:2.0:nameid-format:persistent"
	NAMEIDPOLICYENUM_URN_OASIS_NAMES_TC_SAML_1_1_NAMEID_FORMAT_X509_SUBJECT_NAME             NameIdPolicyEnum = "urn:oasis:names:tc:SAML:1.1:nameid-format:X509SubjectName"
	NAMEIDPOLICYENUM_URN_OASIS_NAMES_TC_SAML_2_0_NAMEID_FORMAT_WINDOWS_DOMAIN_QUALIFIED_NAME NameIdPolicyEnum = "urn:oasis:names:tc:SAML:2.0:nameid-format:WindowsDomainQualifiedName"
	NAMEIDPOLICYENUM_URN_OASIS_NAMES_TC_SAML_2_0_NAMEID_FORMAT_TRANSIENT                     NameIdPolicyEnum = "urn:oasis:names:tc:SAML:2.0:nameid-format:transient"
)
