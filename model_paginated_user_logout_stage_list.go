...
// checks if the PaginatedUserLogoutStageList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedUserLogoutStageList{}
...
type _PaginatedUserLogoutStageList PaginatedUserLogoutStageList
...
func (o PaginatedUserLogoutStageList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedUserLogoutStageList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedUserLogoutStageList := _PaginatedUserLogoutStageList{}

	err = json.Unmarshal(data, &varPaginatedUserLogoutStageList)

	if err != nil {
		return err
	}

	*o = PaginatedUserLogoutStageList(varPaginatedUserLogoutStageList)
