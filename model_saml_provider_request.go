...
func (o *SAMLProviderRequest) GetIssuerOverride() string {
...
// and a boolean to check if the value has been set.
func (o *SAMLProviderRequest) GetIssuerOverrideOk() (*string, bool) {
	if o == nil || IsNil(o.IssuerOverride) {
		return nil, false
	}
...
func (o *SAMLProviderRequest) HasIssuerOverride() bool {
	if o != nil && !IsNil(o.IssuerOverride) {
		return true
	}
...
func (o *SAMLProviderRequest) SetIssuerOverride(v string) {
	o.IssuerOverride = &v
}
