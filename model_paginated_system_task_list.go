...
type _PaginatedSystemTaskList PaginatedSystemTaskList
...
func (o *PaginatedSystemTaskList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedSystemTaskList := _PaginatedSystemTaskList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaginatedSystemTaskList)

	if err != nil {
		return err
	}

	*o = PaginatedSystemTaskList(varPaginatedSystemTaskList)
