...
type ApiProvidersOauth2DcrCreateRequest struct {
	ctx                                    context.Context
	ApiService                             *ProvidersAPIService
	oAuth2DynamicClientRegistrationRequest *OAuth2DynamicClientRegistrationRequest
}

func (r ApiProvidersOauth2DcrCreateRequest) OAuth2DynamicClientRegistrationRequest(oAuth2DynamicClientRegistrationRequest OAuth2DynamicClientRegistrationRequest) ApiProvidersOauth2DcrCreateRequest {
	r.oAuth2DynamicClientRegistrationRequest = &oAuth2DynamicClientRegistrationRequest
	return r
}

func (r ApiProvidersOauth2DcrCreateRequest) Execute() (*OAuth2DynamicClientRegistration, *http.Response, error) {
	return r.ApiService.ProvidersOauth2DcrCreateExecute(r)
}

/*
ProvidersOauth2DcrCreate Method for ProvidersOauth2DcrCreate

OAuth2 Dynamic Client Registration configuration ViewSet

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiProvidersOauth2DcrCreateRequest
*/
func (a *ProvidersAPIService) ProvidersOauth2DcrCreate(ctx context.Context) ApiProvidersOauth2DcrCreateRequest {
	return ApiProvidersOauth2DcrCreateRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ProvidersAPIService) ProvidersOauth2DcrCreateExecute(r ApiProvidersOauth2DcrCreateRequest) (*OAuth2DynamicClientRegistration, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *OAuth2DynamicClientRegistration
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvidersAPIService.ProvidersOauth2DcrCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/providers/oauth2-dcr/"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.oAuth2DynamicClientRegistrationRequest == nil {
		return localVarReturnValue, nil, reportError("oAuth2DynamicClientRegistrationRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.oAuth2DynamicClientRegistrationRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiProvidersOauth2DcrDestroyRequest struct {
	ctx        context.Context
	ApiService *ProvidersAPIService
	pbmUuid    string
}

func (r ApiProvidersOauth2DcrDestroyRequest) Execute() (*http.Response, error) {
	return r.ApiService.ProvidersOauth2DcrDestroyExecute(r)
}

/*
ProvidersOauth2DcrDestroy Method for ProvidersOauth2DcrDestroy

OAuth2 Dynamic Client Registration configuration ViewSet

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param pbmUuid A UUID string identifying this OAuth2 Dynamic Client Registration.
	@return ApiProvidersOauth2DcrDestroyRequest
*/
func (a *ProvidersAPIService) ProvidersOauth2DcrDestroy(ctx context.Context, pbmUuid string) ApiProvidersOauth2DcrDestroyRequest {
	return ApiProvidersOauth2DcrDestroyRequest{
		ApiService: a,
		ctx:        ctx,
		pbmUuid:    pbmUuid,
...
// Execute executes the request
func (a *ProvidersAPIService) ProvidersOauth2DcrDestroyExecute(r ApiProvidersOauth2DcrDestroyRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvidersAPIService.ProvidersOauth2DcrDestroy")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/providers/oauth2-dcr/{pbm_uuid}/"
...
type ApiProvidersOauth2DcrListRequest struct {
	ctx        context.Context
	ApiService *ProvidersAPIService
	ordering   *string
	page       *int32
...
// Which field to use when ordering the results.
func (r ApiProvidersOauth2DcrListRequest) Ordering(ordering string) ApiProvidersOauth2DcrListRequest {
	r.ordering = &ordering
	return r
}

// A page number within the paginated result set.
func (r ApiProvidersOauth2DcrListRequest) Page(page int32) ApiProvidersOauth2DcrListRequest {
	r.page = &page
	return r
}

// Number of results to return per page.
func (r ApiProvidersOauth2DcrListRequest) PageSize(pageSize int32) ApiProvidersOauth2DcrListRequest {
	r.pageSize = &pageSize
	return r
}

func (r ApiProvidersOauth2DcrListRequest) Provider(provider int32) ApiProvidersOauth2DcrListRequest {
	r.provider = &provider
	return r
}

// A search term.
func (r ApiProvidersOauth2DcrListRequest) Search(search string) ApiProvidersOauth2DcrListRequest {
	r.search = &search
	return r
}

func (r ApiProvidersOauth2DcrListRequest) Execute() (*PaginatedOAuth2DynamicClientRegistrationList, *http.Response, error) {
	return r.ApiService.ProvidersOauth2DcrListExecute(r)
}

/*
ProvidersOauth2DcrList Method for ProvidersOauth2DcrList

OAuth2 Dynamic Client Registration configuration ViewSet

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiProvidersOauth2DcrListRequest
*/
func (a *ProvidersAPIService) ProvidersOauth2DcrList(ctx context.Context) ApiProvidersOauth2DcrListRequest {
	return ApiProvidersOauth2DcrListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ProvidersAPIService) ProvidersOauth2DcrListExecute(r ApiProvidersOauth2DcrListRequest) (*PaginatedOAuth2DynamicClientRegistrationList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *PaginatedOAuth2DynamicClientRegistrationList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvidersAPIService.ProvidersOauth2DcrList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiProvidersOauth2DcrPartialUpdateRequest struct {
	ctx                                           context.Context
	ApiService                                    *ProvidersAPIService
	pbmUuid                                       string
...
func (r ApiProvidersOauth2DcrPartialUpdateRequest) PatchedOAuth2DynamicClientRegistrationRequest(patchedOAuth2DynamicClientRegistrationRequest PatchedOAuth2DynamicClientRegistrationRequest) ApiProvidersOauth2DcrPartialUpdateRequest {
	r.patchedOAuth2DynamicClientRegistrationRequest = &patchedOAuth2DynamicClientRegistrationRequest
	return r
}

func (r ApiProvidersOauth2DcrPartialUpdateRequest) Execute() (*OAuth2DynamicClientRegistration, *http.Response, error) {
	return r.ApiService.ProvidersOauth2DcrPartialUpdateExecute(r)
}

/*
ProvidersOauth2DcrPartialUpdate Method for ProvidersOauth2DcrPartialUpdate

OAuth2 Dynamic Client Registration configuration ViewSet

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param pbmUuid A UUID string identifying this OAuth2 Dynamic Client Registration.
	@return ApiProvidersOauth2DcrPartialUpdateRequest
*/
func (a *ProvidersAPIService) ProvidersOauth2DcrPartialUpdate(ctx context.Context, pbmUuid string) ApiProvidersOauth2DcrPartialUpdateRequest {
	return ApiProvidersOauth2DcrPartialUpdateRequest{
		ApiService: a,
		ctx:        ctx,
		pbmUuid:    pbmUuid,
...
//
//	@return OAuth2DynamicClientRegistration
func (a *ProvidersAPIService) ProvidersOauth2DcrPartialUpdateExecute(r ApiProvidersOauth2DcrPartialUpdateRequest) (*OAuth2DynamicClientRegistration, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvidersAPIService.ProvidersOauth2DcrPartialUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.patchedOAuth2DynamicClientRegistrationRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiProvidersOauth2DcrRetrieveRequest struct {
	ctx        context.Context
	ApiService *ProvidersAPIService
	pbmUuid    string
}

func (r ApiProvidersOauth2DcrRetrieveRequest) Execute() (*OAuth2DynamicClientRegistration, *http.Response, error) {
	return r.ApiService.ProvidersOauth2DcrRetrieveExecute(r)
}

/*
ProvidersOauth2DcrRetrieve Method for ProvidersOauth2DcrRetrieve

OAuth2 Dynamic Client Registration configuration ViewSet

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param pbmUuid A UUID string identifying this OAuth2 Dynamic Client Registration.
	@return ApiProvidersOauth2DcrRetrieveRequest
*/
func (a *ProvidersAPIService) ProvidersOauth2DcrRetrieve(ctx context.Context, pbmUuid string) ApiProvidersOauth2DcrRetrieveRequest {
	return ApiProvidersOauth2DcrRetrieveRequest{
		ApiService: a,
		ctx:        ctx,
		pbmUuid:    pbmUuid,
...
//
//	@return OAuth2DynamicClientRegistration
func (a *ProvidersAPIService) ProvidersOauth2DcrRetrieveExecute(r ApiProvidersOauth2DcrRetrieveRequest) (*OAuth2DynamicClientRegistration, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvidersAPIService.ProvidersOauth2DcrRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiProvidersOauth2DcrUpdateRequest struct {
	ctx                                    context.Context
	ApiService                             *ProvidersAPIService
	pbmUuid                                string
	oAuth2DynamicClientRegistrationRequest *OAuth2DynamicClientRegistrationRequest
...
func (r ApiProvidersOauth2DcrUpdateRequest) OAuth2DynamicClientRegistrationRequest(oAuth2DynamicClientRegistrationRequest OAuth2DynamicClientRegistrationRequest) ApiProvidersOauth2DcrUpdateRequest {
	r.oAuth2DynamicClientRegistrationRequest = &oAuth2DynamicClientRegistrationRequest
	return r
}

func (r ApiProvidersOauth2DcrUpdateRequest) Execute() (*OAuth2DynamicClientRegistration, *http.Response, error) {
	return r.ApiService.ProvidersOauth2DcrUpdateExecute(r)
}

/*
ProvidersOauth2DcrUpdate Method for ProvidersOauth2DcrUpdate

OAuth2 Dynamic Client Registration configuration ViewSet

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param pbmUuid A UUID string identifying this OAuth2 Dynamic Client Registration.
	@return ApiProvidersOauth2DcrUpdateRequest
*/
func (a *ProvidersAPIService) ProvidersOauth2DcrUpdate(ctx context.Context, pbmUuid string) ApiProvidersOauth2DcrUpdateRequest {
	return ApiProvidersOauth2DcrUpdateRequest{
		ApiService: a,
		ctx:        ctx,
		pbmUuid:    pbmUuid,
...
//
//	@return OAuth2DynamicClientRegistration
func (a *ProvidersAPIService) ProvidersOauth2DcrUpdateExecute(r ApiProvidersOauth2DcrUpdateRequest) (*OAuth2DynamicClientRegistration, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProvidersAPIService.ProvidersOauth2DcrUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiProvidersSamlListRequest) IssuerOverride(issuerOverride string) ApiProvidersSamlListRequest {
	r.issuerOverride = &issuerOverride
	return r
}
...
func (a *ProvidersAPIService) ProvidersSamlListExecute(r ApiProvidersSamlListRequest) (*PaginatedSAMLProviderList, *http.Response, error) {
	...
	if r.issuerOverride != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "issuer_override", r.issuerOverride, "form", "")
	}
...
func (r ApiProvidersWsfedListRequest) IssuerOverride(issuerOverride string) ApiProvidersWsfedListRequest {
	r.issuerOverride = &issuerOverride
	return r
}
...
func (r ApiProvidersWsfedListRequest) SamlVersion(samlVersion SamlVersionEnum) ApiProvidersWsfedListRequest {
	r.samlVersion = &samlVersion
	return r
}
...
func (a *ProvidersAPIService) ProvidersWsfedListExecute(r ApiProvidersWsfedListRequest) (*PaginatedWSFederationProviderList, *http.Response, error) {
	...
	if r.samlVersion != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "saml_version", r.samlVersion, "form", "")
	}
	if r.search != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "search", r.search, "form", "")
	}
