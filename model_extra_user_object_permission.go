...
// checks if the ExtraUserObjectPermission type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtraUserObjectPermission{}
...
type _ExtraUserObjectPermission ExtraUserObjectPermission
...
func (o ExtraUserObjectPermission) ToMap() (map[string]interface{}, error) {
...
func (o *ExtraUserObjectPermission) UnmarshalJSON(data []byte) (err error) {
	...
	varExtraUserObjectPermission := _ExtraUserObjectPermission{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExtraUserObjectPermission)

	if err != nil {
		return err
	}

	*o = ExtraUserObjectPermission(varExtraUserObjectPermission)
