...
// GoogleProviderMapping GoogleProviderMapping Serializer
type GoogleProviderMapping struct {
	Pk string `json:"pk"`
...
func (o *GoogleProviderMapping) SetManagedNil() {
	o.Managed.Set(nil)
}
...
func (o GoogleProviderMapping) MarshalJSON() ([]byte, error) {
...
type NullableGoogleProviderMapping struct {
	value *GoogleProviderMapping
	isSet bool
}

func (v NullableGoogleProviderMapping) Get() *GoogleProviderMapping {
	return v.value
}

func (v *NullableGoogleProviderMapping) Set(val *GoogleProviderMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableGoogleProviderMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableGoogleProviderMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGoogleProviderMapping(val *GoogleProviderMapping) *NullableGoogleProviderMapping {
	return &NullableGoogleProviderMapping{value: val, isSet: true}
}

func (v NullableGoogleProviderMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGoogleProviderMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
