...
// checks if the TelegramSourcePropertyMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelegramSourcePropertyMapping{}
...
func NewTelegramSourcePropertyMapping(pk string, name string, expression string, component string, verboseName string, verboseNamePlural string, metaModelName string) *TelegramSourcePropertyMapping {
	this := TelegramSourcePropertyMapping{}
	this.Pk = pk
	this.Name = name
...
func (o *TelegramSourcePropertyMapping) SetManagedNil() {
	o.Managed.Set(nil)
}
...
func (o TelegramSourcePropertyMapping) MarshalJSON() ([]byte, error) {
...
func (o TelegramSourcePropertyMapping) ToMap() (map[string]interface{}, error) {
...
func (o *TelegramSourcePropertyMapping) UnmarshalJSON(data []byte) (err error) {
...
type NullableTelegramSourcePropertyMapping struct {
	value *TelegramSourcePropertyMapping
	isSet bool
}

func (v NullableTelegramSourcePropertyMapping) Get() *TelegramSourcePropertyMapping {
	return v.value
}

func (v *NullableTelegramSourcePropertyMapping) Set(val *TelegramSourcePropertyMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableTelegramSourcePropertyMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableTelegramSourcePropertyMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTelegramSourcePropertyMapping(val *TelegramSourcePropertyMapping) *NullableTelegramSourcePropertyMapping {
	return &NullableTelegramSourcePropertyMapping{value: val, isSet: true}
}

func (v NullableTelegramSourcePropertyMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTelegramSourcePropertyMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
