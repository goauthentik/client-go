...
type _PatchedMicrosoftEntraProviderMappingRequest PatchedMicrosoftEntraProviderMappingRequest
...
func (o *PatchedMicrosoftEntraProviderMappingRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedMicrosoftEntraProviderMappingRequest := _PatchedMicrosoftEntraProviderMappingRequest{}

	err = json.Unmarshal(data, &varPatchedMicrosoftEntraProviderMappingRequest)

	if err != nil {
		return err
	}

	*o = PatchedMicrosoftEntraProviderMappingRequest(varPatchedMicrosoftEntraProviderMappingRequest)
