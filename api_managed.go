...
type ApiManagedBlueprintsImportCreateRequest struct {
	ctx        context.Context
	ApiService *ManagedAPIService
	file       *os.File
	path       *string
...
func (r ApiManagedBlueprintsImportCreateRequest) File(file *os.File) ApiManagedBlueprintsImportCreateRequest {
	r.file = file
	return r
}

func (r ApiManagedBlueprintsImportCreateRequest) Path(path string) ApiManagedBlueprintsImportCreateRequest {
	r.path = &path
	return r
}

func (r ApiManagedBlueprintsImportCreateRequest) Context(context string) ApiManagedBlueprintsImportCreateRequest {
	r.context = &context
	return r
}

func (r ApiManagedBlueprintsImportCreateRequest) Execute() (*BlueprintImportResult, *http.Response, error) {
	return r.ApiService.ManagedBlueprintsImportCreateExecute(r)
}

/*
ManagedBlueprintsImportCreate Method for ManagedBlueprintsImportCreate

Import blueprint from .yaml file and apply it once, without creating an instance

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiManagedBlueprintsImportCreateRequest
*/
func (a *ManagedAPIService) ManagedBlueprintsImportCreate(ctx context.Context) ApiManagedBlueprintsImportCreateRequest {
	return ApiManagedBlueprintsImportCreateRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ManagedAPIService) ManagedBlueprintsImportCreateExecute(r ApiManagedBlueprintsImportCreateRequest) (*BlueprintImportResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *BlueprintImportResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagedAPIService.ManagedBlueprintsImportCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/managed/blueprints/import/"
