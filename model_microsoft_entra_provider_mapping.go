...
// checks if the MicrosoftEntraProviderMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MicrosoftEntraProviderMapping{}
...
type _MicrosoftEntraProviderMapping MicrosoftEntraProviderMapping
...
func NewMicrosoftEntraProviderMapping(pk string, name string, expression string, component string, verboseName string, verboseNamePlural string, metaModelName string) *MicrosoftEntraProviderMapping {
	this := MicrosoftEntraProviderMapping{}
	this.Pk = pk
	this.Name = name
...
func (o *MicrosoftEntraProviderMapping) SetManagedNil() {
	o.Managed.Set(nil)
}
...
func (o MicrosoftEntraProviderMapping) MarshalJSON() ([]byte, error) {
...
func (o MicrosoftEntraProviderMapping) ToMap() (map[string]interface{}, error) {
...
func (o *MicrosoftEntraProviderMapping) UnmarshalJSON(data []byte) (err error) {
	...
	varMicrosoftEntraProviderMapping := _MicrosoftEntraProviderMapping{}

	err = json.Unmarshal(data, &varMicrosoftEntraProviderMapping)

	if err != nil {
		return err
	}

	*o = MicrosoftEntraProviderMapping(varMicrosoftEntraProviderMapping)
...
type NullableMicrosoftEntraProviderMapping struct {
	value *MicrosoftEntraProviderMapping
	isSet bool
}

func (v NullableMicrosoftEntraProviderMapping) Get() *MicrosoftEntraProviderMapping {
	return v.value
}

func (v *NullableMicrosoftEntraProviderMapping) Set(val *MicrosoftEntraProviderMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftEntraProviderMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftEntraProviderMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftEntraProviderMapping(val *MicrosoftEntraProviderMapping) *NullableMicrosoftEntraProviderMapping {
	return &NullableMicrosoftEntraProviderMapping{value: val, isSet: true}
}

func (v NullableMicrosoftEntraProviderMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftEntraProviderMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
