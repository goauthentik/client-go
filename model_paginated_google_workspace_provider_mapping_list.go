...
// checks if the PaginatedGoogleWorkspaceProviderMappingList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedGoogleWorkspaceProviderMappingList{}
...
type _PaginatedGoogleWorkspaceProviderMappingList PaginatedGoogleWorkspaceProviderMappingList
...
func (o PaginatedGoogleWorkspaceProviderMappingList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedGoogleWorkspaceProviderMappingList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedGoogleWorkspaceProviderMappingList := _PaginatedGoogleWorkspaceProviderMappingList{}

	err = json.Unmarshal(data, &varPaginatedGoogleWorkspaceProviderMappingList)

	if err != nil {
		return err
	}

	*o = PaginatedGoogleWorkspaceProviderMappingList(varPaginatedGoogleWorkspaceProviderMappingList)
