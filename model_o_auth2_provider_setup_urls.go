...
type OAuth2ProviderSetupURLs struct {
	...
	DcrRegistration      NullableString `json:"dcr_registration"`
...
func NewOAuth2ProviderSetupURLs(issuer string, authorize string, token string, userInfo string, providerInfo string, logout string, jwks string, dcrRegistration NullableString) *OAuth2ProviderSetupURLs {
	...
	this.Logout = logout
	this.Jwks = jwks
	this.DcrRegistration = dcrRegistration
	return &this
}
...
// GetDcrRegistration returns the DcrRegistration field value
// If the value is explicit nil, the zero value for string will be returned
func (o *OAuth2ProviderSetupURLs) GetDcrRegistration() string {
	if o == nil || o.DcrRegistration.Get() == nil {
		var ret string
		return ret
	}

	return *o.DcrRegistration.Get()
}

// GetDcrRegistrationOk returns a tuple with the DcrRegistration field value
// and a boolean to check if the value has been set.
...
func (o *OAuth2ProviderSetupURLs) GetDcrRegistrationOk() (*string, bool) {
	...
	return o.DcrRegistration.Get(), o.DcrRegistration.IsSet()
}

// SetDcrRegistration sets field value
func (o *OAuth2ProviderSetupURLs) SetDcrRegistration(v string) {
	o.DcrRegistration.Set(&v)
}
...
func (o OAuth2ProviderSetupURLs) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["dcr_registration"] = o.DcrRegistration.Get()
...
func (o *OAuth2ProviderSetupURLs) UnmarshalJSON(data []byte) (err error) {
	...
	*o = OAuth2ProviderSetupURLs(varOAuth2ProviderSetupURLs)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "dcr_registration")
