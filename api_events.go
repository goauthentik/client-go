...
func (r ApiEventsEventsTopPerUserListRequest) Actions(actions []EventActions) ApiEventsEventsTopPerUserListRequest {
	r.actions = &actions
	return r
}

// Brand name
func (r ApiEventsEventsTopPerUserListRequest) BrandName(brandName string) ApiEventsEventsTopPerUserListRequest {
	r.brandName = &brandName
	return r
}
...
// Context Device Primary Key
func (r ApiEventsEventsTopPerUserListRequest) ContextDevice(contextDevice string) ApiEventsEventsTopPerUserListRequest {
	r.contextDevice = &contextDevice
	return r
}
...
func (a *EventsAPIService) EventsEventsTopPerUserListExecute(r ApiEventsEventsTopPerUserListRequest) ([]EventTopPerUser, *http.Response, error) {
	...
	if r.topN != nil {
		...
		parameterAddToHeaderOrQuery(localVarQueryParams, "top_n", defaultValue, "form", "")
		r.topN = &defaultValue
	}
	if r.username != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "username", r.username, "form", "")
