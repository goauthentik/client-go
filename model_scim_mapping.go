...
// checks if the SCIMMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SCIMMapping{}
...
func (o *SCIMMapping) SetManagedNil() {
	o.Managed.Set(nil)
}
...
func (o SCIMMapping) MarshalJSON() ([]byte, error) {
...
func (o SCIMMapping) ToMap() (map[string]interface{}, error) {
...
func (o *SCIMMapping) UnmarshalJSON(data []byte) (err error) {
	...
	varSCIMMapping := _SCIMMapping{}

	err = json.Unmarshal(data, &varSCIMMapping)

	if err != nil {
		return err
	}

	*o = SCIMMapping(varSCIMMapping)
...
type NullableSCIMMapping struct {
	value *SCIMMapping
	isSet bool
}

func (v NullableSCIMMapping) Get() *SCIMMapping {
	return v.value
}

func (v *NullableSCIMMapping) Set(val *SCIMMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableSCIMMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableSCIMMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSCIMMapping(val *SCIMMapping) *NullableSCIMMapping {
	return &NullableSCIMMapping{value: val, isSet: true}
}

func (v NullableSCIMMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSCIMMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
