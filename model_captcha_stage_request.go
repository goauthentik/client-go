...
type CaptchaStageRequest struct {
	...
	RequestContentType *RequestContentTypeEnum `json:"request_content_type,omitempty"`
...
func (o *CaptchaStageRequest) GetRequestContentType() RequestContentTypeEnum {
	if o == nil || IsNil(o.RequestContentType) {
		var ret RequestContentTypeEnum
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CaptchaStageRequest) GetRequestContentTypeOk() (*RequestContentTypeEnum, bool) {
	if o == nil || IsNil(o.RequestContentType) {
		return nil, false
	}
...
func (o *CaptchaStageRequest) HasRequestContentType() bool {
	if o != nil && !IsNil(o.RequestContentType) {
		return true
	}
...
// SetRequestContentType gets a reference to the given RequestContentTypeEnum and assigns it to the RequestContentType field.
func (o *CaptchaStageRequest) SetRequestContentType(v RequestContentTypeEnum) {
