...
var _ MappedNullable = &GroupSourceConnection{}
...
func (o GroupSourceConnection) ToMap() (map[string]interface{}, error) {
...
func (o *GroupSourceConnection) UnmarshalJSON(data []byte) (err error) {
