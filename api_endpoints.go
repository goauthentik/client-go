...
type ApiEndpointsAgentsPssoIseCreateRequest struct {
	ctx                                  context.Context
	ApiService                           *EndpointsAPIService
	appleIndependentSecureEnclaveRequest *AppleIndependentSecureEnclaveRequest
}

func (r ApiEndpointsAgentsPssoIseCreateRequest) AppleIndependentSecureEnclaveRequest(appleIndependentSecureEnclaveRequest AppleIndependentSecureEnclaveRequest) ApiEndpointsAgentsPssoIseCreateRequest {
	r.appleIndependentSecureEnclaveRequest = &appleIndependentSecureEnclaveRequest
	return r
}

func (r ApiEndpointsAgentsPssoIseCreateRequest) Execute() (*AppleIndependentSecureEnclave, *http.Response, error) {
	return r.ApiService.EndpointsAgentsPssoIseCreateExecute(r)
}

/*
EndpointsAgentsPssoIseCreate Method for EndpointsAgentsPssoIseCreate

Mixin to add a used_by endpoint to return a list of all objects using this object

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiEndpointsAgentsPssoIseCreateRequest
*/
func (a *EndpointsAPIService) EndpointsAgentsPssoIseCreate(ctx context.Context) ApiEndpointsAgentsPssoIseCreateRequest {
	return ApiEndpointsAgentsPssoIseCreateRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *EndpointsAPIService) EndpointsAgentsPssoIseCreateExecute(r ApiEndpointsAgentsPssoIseCreateRequest) (*AppleIndependentSecureEnclave, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AppleIndependentSecureEnclave
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EndpointsAPIService.EndpointsAgentsPssoIseCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/endpoints/agents/psso/ise/"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.appleIndependentSecureEnclaveRequest == nil {
		return localVarReturnValue, nil, reportError("appleIndependentSecureEnclaveRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.appleIndependentSecureEnclaveRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiEndpointsAgentsPssoIseDestroyRequest struct {
	ctx        context.Context
	ApiService *EndpointsAPIService
	uuid       string
}

func (r ApiEndpointsAgentsPssoIseDestroyRequest) Execute() (*http.Response, error) {
	return r.ApiService.EndpointsAgentsPssoIseDestroyExecute(r)
}

/*
EndpointsAgentsPssoIseDestroy Method for EndpointsAgentsPssoIseDestroy

Mixin to add a used_by endpoint to return a list of all objects using this object

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param uuid A UUID string identifying this Apple Independent Secure Enclave.
	@return ApiEndpointsAgentsPssoIseDestroyRequest
*/
func (a *EndpointsAPIService) EndpointsAgentsPssoIseDestroy(ctx context.Context, uuid string) ApiEndpointsAgentsPssoIseDestroyRequest {
	return ApiEndpointsAgentsPssoIseDestroyRequest{
		ApiService: a,
		ctx:        ctx,
		uuid:       uuid,
...
// Execute executes the request
func (a *EndpointsAPIService) EndpointsAgentsPssoIseDestroyExecute(r ApiEndpointsAgentsPssoIseDestroyRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EndpointsAPIService.EndpointsAgentsPssoIseDestroy")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/endpoints/agents/psso/ise/{uuid}/"
...
type ApiEndpointsAgentsPssoIseListRequest struct {
	ctx               context.Context
	ApiService        *EndpointsAPIService
...
func (r ApiEndpointsAgentsPssoIseListRequest) AppleEnclaveKeyId(appleEnclaveKeyId string) ApiEndpointsAgentsPssoIseListRequest {
	r.appleEnclaveKeyId = &appleEnclaveKeyId
	return r
}

// Which field to use when ordering the results.
func (r ApiEndpointsAgentsPssoIseListRequest) Ordering(ordering string) ApiEndpointsAgentsPssoIseListRequest {
	r.ordering = &ordering
	return r
}

// A page number within the paginated result set.
func (r ApiEndpointsAgentsPssoIseListRequest) Page(page int32) ApiEndpointsAgentsPssoIseListRequest {
	r.page = &page
	return r
}

// Number of results to return per page.
func (r ApiEndpointsAgentsPssoIseListRequest) PageSize(pageSize int32) ApiEndpointsAgentsPssoIseListRequest {
	r.pageSize = &pageSize
	return r
}

// A search term.
func (r ApiEndpointsAgentsPssoIseListRequest) Search(search string) ApiEndpointsAgentsPssoIseListRequest {
	r.search = &search
	return r
}

func (r ApiEndpointsAgentsPssoIseListRequest) User(user int32) ApiEndpointsAgentsPssoIseListRequest {
	r.user = &user
	return r
}

func (r ApiEndpointsAgentsPssoIseListRequest) Execute() (*PaginatedAppleIndependentSecureEnclaveList, *http.Response, error) {
	return r.ApiService.EndpointsAgentsPssoIseListExecute(r)
}

/*
EndpointsAgentsPssoIseList Method for EndpointsAgentsPssoIseList

Mixin to add a used_by endpoint to return a list of all objects using this object

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiEndpointsAgentsPssoIseListRequest
*/
func (a *EndpointsAPIService) EndpointsAgentsPssoIseList(ctx context.Context) ApiEndpointsAgentsPssoIseListRequest {
	return ApiEndpointsAgentsPssoIseListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *EndpointsAPIService) EndpointsAgentsPssoIseListExecute(r ApiEndpointsAgentsPssoIseListRequest) (*PaginatedAppleIndependentSecureEnclaveList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *PaginatedAppleIndependentSecureEnclaveList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EndpointsAPIService.EndpointsAgentsPssoIseList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.appleEnclaveKeyId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "apple_enclave_key_id", r.appleEnclaveKeyId, "form", "")
	}
	if r.ordering != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ordering", r.ordering, "form", "")
	}
...
type ApiEndpointsAgentsPssoIsePartialUpdateRequest struct {
	ctx                                         context.Context
	ApiService                                  *EndpointsAPIService
	uuid                                        string
...
func (r ApiEndpointsAgentsPssoIsePartialUpdateRequest) PatchedAppleIndependentSecureEnclaveRequest(patchedAppleIndependentSecureEnclaveRequest PatchedAppleIndependentSecureEnclaveRequest) ApiEndpointsAgentsPssoIsePartialUpdateRequest {
	r.patchedAppleIndependentSecureEnclaveRequest = &patchedAppleIndependentSecureEnclaveRequest
	return r
}

func (r ApiEndpointsAgentsPssoIsePartialUpdateRequest) Execute() (*AppleIndependentSecureEnclave, *http.Response, error) {
	return r.ApiService.EndpointsAgentsPssoIsePartialUpdateExecute(r)
}

/*
EndpointsAgentsPssoIsePartialUpdate Method for EndpointsAgentsPssoIsePartialUpdate

Mixin to add a used_by endpoint to return a list of all objects using this object

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param uuid A UUID string identifying this Apple Independent Secure Enclave.
	@return ApiEndpointsAgentsPssoIsePartialUpdateRequest
*/
func (a *EndpointsAPIService) EndpointsAgentsPssoIsePartialUpdate(ctx context.Context, uuid string) ApiEndpointsAgentsPssoIsePartialUpdateRequest {
	return ApiEndpointsAgentsPssoIsePartialUpdateRequest{
		ApiService: a,
		ctx:        ctx,
		uuid:       uuid,
...
//
//	@return AppleIndependentSecureEnclave
func (a *EndpointsAPIService) EndpointsAgentsPssoIsePartialUpdateExecute(r ApiEndpointsAgentsPssoIsePartialUpdateRequest) (*AppleIndependentSecureEnclave, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EndpointsAPIService.EndpointsAgentsPssoIsePartialUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.patchedAppleIndependentSecureEnclaveRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiEndpointsAgentsPssoIseRetrieveRequest struct {
	ctx        context.Context
	ApiService *EndpointsAPIService
	uuid       string
}

func (r ApiEndpointsAgentsPssoIseRetrieveRequest) Execute() (*AppleIndependentSecureEnclave, *http.Response, error) {
	return r.ApiService.EndpointsAgentsPssoIseRetrieveExecute(r)
}

/*
EndpointsAgentsPssoIseRetrieve Method for EndpointsAgentsPssoIseRetrieve

Mixin to add a used_by endpoint to return a list of all objects using this object

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param uuid A UUID string identifying this Apple Independent Secure Enclave.
	@return ApiEndpointsAgentsPssoIseRetrieveRequest
*/
func (a *EndpointsAPIService) EndpointsAgentsPssoIseRetrieve(ctx context.Context, uuid string) ApiEndpointsAgentsPssoIseRetrieveRequest {
	return ApiEndpointsAgentsPssoIseRetrieveRequest{
		ApiService: a,
		ctx:        ctx,
		uuid:       uuid,
...
//
//	@return AppleIndependentSecureEnclave
func (a *EndpointsAPIService) EndpointsAgentsPssoIseRetrieveExecute(r ApiEndpointsAgentsPssoIseRetrieveRequest) (*AppleIndependentSecureEnclave, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EndpointsAPIService.EndpointsAgentsPssoIseRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiEndpointsAgentsPssoIseUpdateRequest struct {
	ctx                                  context.Context
	ApiService                           *EndpointsAPIService
	uuid                                 string
	appleIndependentSecureEnclaveRequest *AppleIndependentSecureEnclaveRequest
...
func (r ApiEndpointsAgentsPssoIseUpdateRequest) AppleIndependentSecureEnclaveRequest(appleIndependentSecureEnclaveRequest AppleIndependentSecureEnclaveRequest) ApiEndpointsAgentsPssoIseUpdateRequest {
	r.appleIndependentSecureEnclaveRequest = &appleIndependentSecureEnclaveRequest
	return r
}

func (r ApiEndpointsAgentsPssoIseUpdateRequest) Execute() (*AppleIndependentSecureEnclave, *http.Response, error) {
	return r.ApiService.EndpointsAgentsPssoIseUpdateExecute(r)
}

/*
EndpointsAgentsPssoIseUpdate Method for EndpointsAgentsPssoIseUpdate

Mixin to add a used_by endpoint to return a list of all objects using this object

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param uuid A UUID string identifying this Apple Independent Secure Enclave.
	@return ApiEndpointsAgentsPssoIseUpdateRequest
*/
func (a *EndpointsAPIService) EndpointsAgentsPssoIseUpdate(ctx context.Context, uuid string) ApiEndpointsAgentsPssoIseUpdateRequest {
	return ApiEndpointsAgentsPssoIseUpdateRequest{
		ApiService: a,
		ctx:        ctx,
		uuid:       uuid,
...
//
//	@return AppleIndependentSecureEnclave
func (a *EndpointsAPIService) EndpointsAgentsPssoIseUpdateExecute(r ApiEndpointsAgentsPssoIseUpdateRequest) (*AppleIndependentSecureEnclave, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EndpointsAPIService.EndpointsAgentsPssoIseUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiEndpointsAgentsPssoIseUsedByListRequest struct {
	ctx        context.Context
	ApiService *EndpointsAPIService
	uuid       string
}

func (r ApiEndpointsAgentsPssoIseUsedByListRequest) Execute() ([]UsedBy, *http.Response, error) {
	return r.ApiService.EndpointsAgentsPssoIseUsedByListExecute(r)
}

/*
EndpointsAgentsPssoIseUsedByList Method for EndpointsAgentsPssoIseUsedByList

Get a list of all objects that use this object

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param uuid A UUID string identifying this Apple Independent Secure Enclave.
	@return ApiEndpointsAgentsPssoIseUsedByListRequest
*/
func (a *EndpointsAPIService) EndpointsAgentsPssoIseUsedByList(ctx context.Context, uuid string) ApiEndpointsAgentsPssoIseUsedByListRequest {
	return ApiEndpointsAgentsPssoIseUsedByListRequest{
		ApiService: a,
		ctx:        ctx,
		uuid:       uuid,
...
//
//	@return []UsedBy
func (a *EndpointsAPIService) EndpointsAgentsPssoIseUsedByListExecute(r ApiEndpointsAgentsPssoIseUsedByListRequest) ([]UsedBy, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EndpointsAPIService.EndpointsAgentsPssoIseUsedByList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/endpoints/agents/psso/ise/{uuid}/used_by/"
	localVarPath = strings.Replace(localVarPath, "{"+"uuid"+"}", url.PathEscape(parameterValueToString(r.uuid, "uuid")), -1)
