...
type ApiEndpointsAgentsConnectorsAuthenticateInteractiveCreateRequest struct {
	ctx        context.Context
	ApiService *EndpointsApiService
}

func (r ApiEndpointsAgentsConnectorsAuthenticateInteractiveCreateRequest) Execute() (*AgentAuthenticationResponse, *http.Response, error) {
	return r.ApiService.EndpointsAgentsConnectorsAuthenticateInteractiveCreateExecute(r)
}

/*
EndpointsAgentsConnectorsAuthenticateInteractiveCreate Method for EndpointsAgentsConnectorsAuthenticateInteractiveCreate

Mixin to add a used_by endpoint to return a list of all objects using this object

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiEndpointsAgentsConnectorsAuthenticateInteractiveCreateRequest
*/
func (a *EndpointsApiService) EndpointsAgentsConnectorsAuthenticateInteractiveCreate(ctx context.Context) ApiEndpointsAgentsConnectorsAuthenticateInteractiveCreateRequest {
	return ApiEndpointsAgentsConnectorsAuthenticateInteractiveCreateRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *EndpointsApiService) EndpointsAgentsConnectorsAuthenticateInteractiveCreateExecute(r ApiEndpointsAgentsConnectorsAuthenticateInteractiveCreateRequest) (*AgentAuthenticationResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EndpointsApiService.EndpointsAgentsConnectorsAuthenticateInteractiveCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/endpoints/agents/connectors/authenticate_interactive/"
