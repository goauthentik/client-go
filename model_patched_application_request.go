...
type PatchedApplicationRequest struct {
	...
	MetaHide             *bool `json:"meta_hide,omitempty"`
...
// GetMetaHide returns the MetaHide field value if set, zero value otherwise.
func (o *PatchedApplicationRequest) GetMetaHide() bool {
	if o == nil || IsNil(o.MetaHide) {
		var ret bool
		return ret
	}
	return *o.MetaHide
...
// GetMetaHideOk returns a tuple with the MetaHide field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PatchedApplicationRequest) GetMetaHideOk() (*bool, bool) {
	if o == nil || IsNil(o.MetaHide) {
		return nil, false
	}
	return o.MetaHide, true
}

// HasMetaHide returns a boolean if a field has been set.
func (o *PatchedApplicationRequest) HasMetaHide() bool {
	if o != nil && !IsNil(o.MetaHide) {
		return true
	}
...
// SetMetaHide gets a reference to the given bool and assigns it to the MetaHide field.
func (o *PatchedApplicationRequest) SetMetaHide(v bool) {
	o.MetaHide = &v
}
...
func (o PatchedApplicationRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MetaHide) {
		toSerialize["meta_hide"] = o.MetaHide
	}
...
func (o *PatchedApplicationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PatchedApplicationRequest(varPatchedApplicationRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "meta_hide")
