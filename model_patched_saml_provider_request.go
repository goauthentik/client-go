...
func (o *PatchedSAMLProviderRequest) GetIssuerOverride() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedSAMLProviderRequest) GetIssuerOverrideOk() (*string, bool) {
	if o == nil || IsNil(o.IssuerOverride) {
		return nil, false
	}
...
func (o *PatchedSAMLProviderRequest) HasIssuerOverride() bool {
	if o != nil && !IsNil(o.IssuerOverride) {
		return true
	}
...
func (o *PatchedSAMLProviderRequest) SetIssuerOverride(v string) {
	o.IssuerOverride = &v
}
