...
// checks if the PatchedSCIMMappingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedSCIMMappingRequest{}
...
func (o PatchedSCIMMappingRequest) ToMap() (map[string]interface{}, error) {
