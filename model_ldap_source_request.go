...
type LDAPSourceRequest struct {
	...
	SyncGroupHierarchy   *bool `json:"sync_group_hierarchy,omitempty"`
...
// GetSyncGroupHierarchy returns the SyncGroupHierarchy field value if set, zero value otherwise.
func (o *LDAPSourceRequest) GetSyncGroupHierarchy() bool {
	if o == nil || IsNil(o.SyncGroupHierarchy) {
		var ret bool
		return ret
	}
	return *o.SyncGroupHierarchy
}

// GetSyncGroupHierarchyOk returns a tuple with the SyncGroupHierarchy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LDAPSourceRequest) GetSyncGroupHierarchyOk() (*bool, bool) {
	if o == nil || IsNil(o.SyncGroupHierarchy) {
		return nil, false
	}
	return o.SyncGroupHierarchy, true
}

// HasSyncGroupHierarchy returns a boolean if a field has been set.
func (o *LDAPSourceRequest) HasSyncGroupHierarchy() bool {
	if o != nil && !IsNil(o.SyncGroupHierarchy) {
		return true
	}
...
// SetSyncGroupHierarchy gets a reference to the given bool and assigns it to the SyncGroupHierarchy field.
func (o *LDAPSourceRequest) SetSyncGroupHierarchy(v bool) {
	o.SyncGroupHierarchy = &v
}
...
func (o LDAPSourceRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SyncGroupHierarchy) {
		toSerialize["sync_group_hierarchy"] = o.SyncGroupHierarchy
	}
...
func (o *LDAPSourceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = LDAPSourceRequest(varLDAPSourceRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "sync_group_hierarchy")
