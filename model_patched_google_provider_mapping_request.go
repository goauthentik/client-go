...
// PatchedGoogleProviderMappingRequest GoogleProviderMapping Serializer
type PatchedGoogleProviderMappingRequest struct {
...
func NewPatchedGoogleProviderMappingRequest() *PatchedGoogleProviderMappingRequest {
	this := PatchedGoogleProviderMappingRequest{}
	return &this
}
...
func (o *PatchedGoogleProviderMappingRequest) SetManagedNil() {
	o.Managed.Set(nil)
}
...
func (o PatchedGoogleProviderMappingRequest) MarshalJSON() ([]byte, error) {
...
type NullablePatchedGoogleProviderMappingRequest struct {
	value *PatchedGoogleProviderMappingRequest
	isSet bool
}

func (v NullablePatchedGoogleProviderMappingRequest) Get() *PatchedGoogleProviderMappingRequest {
	return v.value
}

func (v *NullablePatchedGoogleProviderMappingRequest) Set(val *PatchedGoogleProviderMappingRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedGoogleProviderMappingRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedGoogleProviderMappingRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedGoogleProviderMappingRequest(val *PatchedGoogleProviderMappingRequest) *NullablePatchedGoogleProviderMappingRequest {
	return &NullablePatchedGoogleProviderMappingRequest{value: val, isSet: true}
}

func (v NullablePatchedGoogleProviderMappingRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedGoogleProviderMappingRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
