...
type SAMLProvider struct {
	...
	UrlIssuer string `json:"url_issuer"`
	// Get unified SAML endpoint URL (handles SSO and SLO)
	UrlUnified string `json:"url_unified"`
	// Get IdP-initiated SAML URL
	UrlUnifiedInit string `json:"url_unified_init"`
	// Get SSO Post URL
...
func NewSAMLProvider(pk int32, name string, authorizationFlow string, invalidationFlow string, component string, assignedApplicationSlug NullableString, assignedApplicationName NullableString, assignedBackchannelApplicationSlug NullableString, assignedBackchannelApplicationName NullableString, verboseName string, verboseNamePlural string, metaModelName string, acsUrl string, urlDownloadMetadata string, urlIssuer string, urlUnified string, urlUnifiedInit string, urlSsoPost string, urlSsoRedirect string, urlSsoInit string, urlSloPost string, urlSloRedirect string) *SAMLProvider {
	this := SAMLProvider{}
	this.Pk = pk
	this.Name = name
	...
	this.UrlUnifiedInit = urlUnifiedInit
...
// GetIssuerOverride returns the IssuerOverride field value if set, zero value otherwise.
func (o *SAMLProvider) GetIssuerOverride() string {
	if o == nil || IsNil(o.IssuerOverride) {
		var ret string
		return ret
	}
	return *o.IssuerOverride
}

// GetIssuerOverrideOk returns a tuple with the IssuerOverride field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SAMLProvider) GetIssuerOverrideOk() (*string, bool) {
	if o == nil || IsNil(o.IssuerOverride) {
		return nil, false
	}
	return o.IssuerOverride, true
}

// HasIssuerOverride returns a boolean if a field has been set.
func (o *SAMLProvider) HasIssuerOverride() bool {
	if o != nil && !IsNil(o.IssuerOverride) {
		return true
	}
...
// SetIssuerOverride gets a reference to the given string and assigns it to the IssuerOverride field.
func (o *SAMLProvider) SetIssuerOverride(v string) {
	o.IssuerOverride = &v
}
...
// GetUrlIssuer returns the UrlIssuer field value
func (o *SAMLProvider) GetUrlIssuer() string {
	if o == nil {
		var ret string
		return ret
	}
...
// GetUrlIssuerOk returns a tuple with the UrlIssuer field value
// and a boolean to check if the value has been set.
func (o *SAMLProvider) GetUrlIssuerOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UrlIssuer, true
}

// SetUrlIssuer sets field value
func (o *SAMLProvider) SetUrlIssuer(v string) {
	o.UrlIssuer = v
}

// GetUrlUnified returns the UrlUnified field value
func (o *SAMLProvider) GetUrlUnified() string {
	if o == nil {
		var ret string
		return ret
	}
...
// GetUrlUnifiedOk returns a tuple with the UrlUnified field value
// and a boolean to check if the value has been set.
func (o *SAMLProvider) GetUrlUnifiedOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UrlUnified, true
}

// SetUrlUnified sets field value
func (o *SAMLProvider) SetUrlUnified(v string) {
	o.UrlUnified = v
}

// GetUrlUnifiedInit returns the UrlUnifiedInit field value
func (o *SAMLProvider) GetUrlUnifiedInit() string {
	if o == nil {
		var ret string
		return ret
	}

	return o.UrlUnifiedInit
}

// GetUrlUnifiedInitOk returns a tuple with the UrlUnifiedInit field value
// and a boolean to check if the value has been set.
func (o *SAMLProvider) GetUrlUnifiedInitOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UrlUnifiedInit, true
}

// SetUrlUnifiedInit sets field value
func (o *SAMLProvider) SetUrlUnifiedInit(v string) {
	o.UrlUnifiedInit = v
}
...
func (o SAMLProvider) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IssuerOverride) {
		toSerialize["issuer_override"] = o.IssuerOverride
	}
	...
	toSerialize["url_issuer"] = o.UrlIssuer
	toSerialize["url_unified"] = o.UrlUnified
	toSerialize["url_unified_init"] = o.UrlUnifiedInit
...
func (o *SAMLProvider) UnmarshalJSON(data []byte) (err error) {
	...
	*o = SAMLProvider(varSAMLProvider)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "issuer_override")
		...
		delete(additionalProperties, "url_issuer")
		delete(additionalProperties, "url_unified")
		delete(additionalProperties, "url_unified_init")
