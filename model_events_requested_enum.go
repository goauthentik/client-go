...
const (
	...
	EVENTSREQUESTEDENUM_HTTPS___SCHEMAS_OPENID_NET_SECEVENT_CAEP_EVENT_TYPE_TOKEN_CLAIMS_CHANGE      EventsRequestedEnum = "https://schemas.openid.net/secevent/caep/event-type/token-claims-change"
	...
	EVENTSREQUESTEDENUM_HTTPS___SCHEMAS_OPENID_NET_SECEVENT_CAEP_EVENT_TYPE_ASSURANCE_LEVEL_CHANGE   EventsRequestedEnum = "https://schemas.openid.net/secevent/caep/event-type/assurance-level-change"
	EVENTSREQUESTEDENUM_HTTPS___SCHEMAS_OPENID_NET_SECEVENT_CAEP_EVENT_TYPE_DEVICE_COMPLIANCE_CHANGE EventsRequestedEnum = "https://schemas.openid.net/secevent/caep/event-type/device-compliance-change"
	EVENTSREQUESTEDENUM_HTTPS___SCHEMAS_OPENID_NET_SECEVENT_CAEP_EVENT_TYPE_SESSION_ESTABLISHED      EventsRequestedEnum = "https://schemas.openid.net/secevent/caep/event-type/session-established"
	EVENTSREQUESTEDENUM_HTTPS___SCHEMAS_OPENID_NET_SECEVENT_CAEP_EVENT_TYPE_SESSION_PRESENTED        EventsRequestedEnum = "https://schemas.openid.net/secevent/caep/event-type/session-presented"
	EVENTSREQUESTEDENUM_HTTPS___SCHEMAS_OPENID_NET_SECEVENT_CAEP_EVENT_TYPE_RISK_LEVEL_CHANGE        EventsRequestedEnum = "https://schemas.openid.net/secevent/caep/event-type/risk-level-change"
